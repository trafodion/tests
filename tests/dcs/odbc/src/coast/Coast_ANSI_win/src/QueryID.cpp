...
//	else
//	{
//		LogMsg(NONE,"Allocate a stmt2 handle successfully.\n");
//	}
//
//	SQLExecDirect(hstmt,(SQLCHAR*)(SQLCHAR *)"CREATE TABLE T1( C1 INT NOT NULL NOT DROPPABLE, C2 INT, C3 INT, C4 INT, PRIMARY KEY( C1 ) )",SQL_NTS);
//
//	TESTCASE_END;
//
////=========================================================================================
...
//	{
//		sprintf( preparedStmt, "PREPARE %s FROM SELECT C1 FROM T1 WHERE C2 > C3 AND C3 > 100", queryIDMatrix[ loop ].queryID );
//		TESTCASE_BEGIN( preparedStmt );
//		LogMsg(NONE,"\n");
//		returncode = SQLPrepare( hstmt, (SQLCHAR *)preparedStmt, SQL_NTS );
...
//		sprintf( infoStatsStmt, "INFOSTATS %s", (char*)cursorName );
//		returncode = SQLBindCol( hstmt2, 1, SQL_C_CHAR, 
...
//		if( strcmp( queryID, queryIDMatrix[ loop ].queryID ) != 0 )
//		{
...
//
//	// Clean up
//	SQLExecDirect(hstmt,(SQLCHAR*)(SQLCHAR *)"DROP TABLE T1",SQL_NTS);
//
////=========================================================================================
//	// Test to make sure we can prepare different kinds of SQL statements.
//	loop = 0;
//	while( strcmp( sqlPrepareMatrix[ loop ].sqlStmt, "STOP" ) != 0 )
//	{
//		sprintf( preparedStmt, "PREPARE STMTID%d FROM %s", loop, sqlPrepareMatrix[ loop ].sqlStmt );
//		TESTCASE_BEGIN( preparedStmt );
//		LogMsg(NONE,"\n");
//		returncode = SQLPrepare( hstmt, (SQLCHAR *)preparedStmt, SQL_NTS );
//		if( returncode != SQL_SUCCESS )
...
//
//	FullDisconnect(pTestInfo);
//	LogMsg(SHORTTIMESTAMP+LINEAFTER,"End testing API => QueryID.\n");
//	TEST_RETURN;
//}
