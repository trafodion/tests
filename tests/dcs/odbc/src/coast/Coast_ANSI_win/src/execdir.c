...
//===========================================================================================================
	var_list_t *var_list;
	var_list = load_api_vars("SQLExecDirect", charset_file);
...
//===========================================================================================================
	...
	LogMsg(LINEBEFORE+SHORTTIMESTAMP,"Begin testing API => SQLExecDirect | SQLExecuteDirect | execdir.c\n");
	...
	sprintf(Heading,"Test +ve Func of SQLExecDirect for insert into...select * from..order by statement (Soln 10-990723-2800)\n");
	TESTCASE_BEGIN(Heading);
