...
PassFail TestMXSQLDescribeColVer3(TestInfo *pTestInfo)
{
...
#ifndef _WM
	#ifdef UNICODE
	SWORD			SQLType[] = {SQL_WCHAR,SQL_VARCHAR,SQL_DECIMAL,SQL_NUMERIC,SQL_SMALLINT,SQL_INTEGER,
									SQL_REAL,SQL_DOUBLE,SQL_DOUBLE,SQL_TYPE_DATE,SQL_TYPE_TIME,SQL_TYPE_TIMESTAMP,SQL_WVARCHAR,SQL_BIGINT,
	...
	SWORD			SQLType[] = {SQL_CHAR,SQL_VARCHAR,SQL_DECIMAL,SQL_NUMERIC,SQL_SMALLINT,SQL_INTEGER,
									SQL_REAL,SQL_DOUBLE,SQL_DOUBLE,SQL_TYPE_DATE,SQL_TYPE_TIME,SQL_TYPE_TIMESTAMP,SQL_VARCHAR,SQL_BIGINT,
...
//===========================================================================================================
	var_list_t *var_list;
	var_list = load_api_vars(_T("SQLDescribeColumns30"), charset_file);
	if (var_list == NULL) return FAILED;

	//print_list(var_list);
	colname[0] = var_mapping(_T("SQLDescribeColumns30_colname_1"), var_list);
	colname[1] = var_mapping(_T("SQLDescribeColumns30_colname_2"), var_list);
	colname[2] = var_mapping(_T("SQLDescribeColumns30_colname_3"), var_list);
	colname[3] = var_mapping(_T("SQLDescribeColumns30_colname_4"), var_list);
	colname[4] = var_mapping(_T("SQLDescribeColumns30_colname_5"), var_list);
	colname[5] = var_mapping(_T("SQLDescribeColumns30_colname_6"), var_list);
	colname[6] = var_mapping(_T("SQLDescribeColumns30_colname_7"), var_list);
	colname[7] = var_mapping(_T("SQLDescribeColumns30_colname_8"), var_list);
	colname[8] = var_mapping(_T("SQLDescribeColumns30_colname_9"), var_list);
	colname[9] = var_mapping(_T("SQLDescribeColumns30_colname_10"), var_list);
	colname[10] = var_mapping(_T("SQLDescribeColumns30_colname_11"), var_list);
	colname[11] = var_mapping(_T("SQLDescribeColumns30_colname_12"), var_list);
	colname[12] = var_mapping(_T("SQLDescribeColumns30_colname_13"), var_list);
	colname[13] = var_mapping(_T("SQLDescribeColumns30_colname_14"), var_list);
	colname[14] = var_mapping(_T("SQLDescribeColumns30_colname_15"), var_list);
	colname[15] = var_mapping(_T("SQLDescribeColumns30_colname_16"), var_list);
	colname[16] = var_mapping(_T("SQLDescribeColumns30_colname_17"), var_list);
	colname[17] = var_mapping(_T("SQLDescribeColumns30_colname_18"), var_list);
	colname[18] = var_mapping(_T("SQLDescribeColumns30_colname_19"), var_list);
	colname[19] = var_mapping(_T("SQLDescribeColumns30_colname_20"), var_list);
	colname[20] = var_mapping(_T("SQLDescribeColumns30_colname_21"), var_list);
	colname[21] = var_mapping(_T("SQLDescribeColumns30_colname_22"), var_list);
	colname[22] = var_mapping(_T("SQLDescribeColumns30_colname_23"), var_list);
	colname[23] = var_mapping(_T("SQLDescribeColumns30_colname_24"), var_list);

#ifdef UNICODE 
	colname[24] = var_mapping(_T("SQLDescribeColumns30_colname_25"), var_list);
	colname[25] = var_mapping(_T("SQLDescribeColumns30_colname_26"), var_list);
	colname[26] = var_mapping(_T("SQLDescribeColumns30_colname_27"), var_list);
#endif

	ExecDirStr[0] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_1"), var_list);
	ExecDirStr[1] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_2"), var_list);
	ExecDirStr[2] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_3"), var_list);
	ExecDirStr[3] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_4"), var_list);
	ExecDirStr[4] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_5"), var_list);
	ExecDirStr[5] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_6"), var_list);
	ExecDirStr[6] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_7"), var_list);
	ExecDirStr[7] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_8"), var_list);
	ExecDirStr[8] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_9"), var_list);
	ExecDirStr[9] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_10"), var_list);
	ExecDirStr[10] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_11"), var_list);
	ExecDirStr[11] = var_mapping(_T("SQLDescribeColumns30_ExecDirStr_12"), var_list);

	colVal[0] = var_mapping(_T("SQLDescribeColumns30_colVal_1"), var_list);
	colVal[1] = var_mapping(_T("SQLDescribeColumns30_colVal_2"), var_list);
//=========================================================================================
