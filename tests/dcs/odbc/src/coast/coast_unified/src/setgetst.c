...
//		{SQL_USE_BOOKMARKS,SQL_UB_OFF,SQL_UB_ON,999,}, 
	...
	TCHAR	*InsTmp,*InsCol,*InsVal3;
	TCHAR	*ParamDataQry[4];
	TCHAR	*ParamDataValue,*TestAsync;
...
//===========================================================================================================
	var_list_t *var_list;
	var_list = load_api_vars(_T("SQLSetStmtOption"), charset_file);
	if (var_list == NULL) return FAILED;

	ExecDirStr[0].DrpTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_DrpTab_0"), var_list);
	ExecDirStr[0].CrtTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_CrtTab_0"), var_list);
	ExecDirStr[0].InsTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_InsTab_0"), var_list);
	ExecDirStr[0].SelTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_SelTab_0"), var_list);

	ExecDirStr[1].DrpTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_DrpTab_1"), var_list);
	ExecDirStr[1].CrtTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_CrtTab_1"), var_list);
	ExecDirStr[1].InsTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_InsTab_1"), var_list);
	ExecDirStr[1].SelTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_SelTab_1"), var_list);

	ExecDirStr[2].DrpTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_DrpTab_2"), var_list);
	ExecDirStr[2].CrtTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_CrtTab_2"), var_list);
	ExecDirStr[2].InsTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_InsTab_2"), var_list);
	ExecDirStr[2].SelTab = var_mapping(_T("SQLSetStmtOption_ExecDirStr_SelTab_2"), var_list);

	ParamDataQry[0] = var_mapping(_T("SQLSetStmtOption_ParamDataQry_0"), var_list);
	ParamDataQry[1] = var_mapping(_T("SQLSetStmtOption_ParamDataQry_1"), var_list);
	ParamDataQry[2] = var_mapping(_T("SQLSetStmtOption_ParamDataQry_2"), var_list);
	ParamDataQry[3] = var_mapping(_T("SQLSetStmtOption_ParamDataQry_3"), var_list);

	SelQuery[0] = var_mapping(_T("SQLSetStmtOption_SelQuery_0"), var_list);
	SelQuery[1] = var_mapping(_T("SQLSetStmtOption_SelQuery_1"), var_list);

	InsVal3 = var_mapping(_T("SQLSetStmtOption_InsVal3"), var_list);

	szInput[0] = var_mapping(_T("SQLSetStmtOption_szInput_0"), var_list);
	szInput[1] = var_mapping(_T("SQLSetStmtOption_szInput_1"), var_list);
	
#ifdef UNICODE
	szInput[12] = var_mapping(_T("SQLSetStmtOption_szInput_12"), var_list);
	szInput[13] = var_mapping(_T("SQLSetStmtOption_szInput_13"), var_list);
	szInput[14] = var_mapping(_T("SQLSetStmtOption_szInput_14"), var_list);
#endif

	ParamDataValue = var_mapping(_T("SQLSetStmtOption_ParamDataValue"), var_list);
	TestAsync = var_mapping(_T("SQLSetStmtOption_TestAsync"), var_list);

	MXTimeOutQry[0] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_0"), var_list);
	MXTimeOutQry[1] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_1"), var_list);
	MXTimeOutQry[2] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_2"), var_list);
	MXTimeOutQry[3] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_3"), var_list);
	MXTimeOutQry[4] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_4"), var_list);
	MXTimeOutQry[5] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_5"), var_list);
	MXTimeOutQry[6] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_6"), var_list);
	MXTimeOutQry[7] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_7"), var_list);
	MXTimeOutQry[8] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_8"), var_list);
	MXTimeOutQry[9] = var_mapping(_T("SQLSetStmtOption_MXTimeOutQry_9"), var_list);

	QryTimeOut[0] = var_mapping(_T("SQLSetStmtOption_QryTimeOut_0"), var_list);
	QryTimeOut[1] = var_mapping(_T("SQLSetStmtOption_QryTimeOut_1"), var_list);
	QryTimeOut[2] = var_mapping(_T("SQLSetStmtOption_QryTimeOut_2"), var_list);
	
//===========================================================================================================

	/* Set up some local variables to save on typing in longer ones */
  
	LogMsg(LINEBEFORE+SHORTTIMESTAMP,_T("Begin testing API =>SQLSetStatement/GetStatement option.\n"));
...
//==============================================================================================================
	...
	for (i = 0; OptionInt[i].fOption != 999; i++) 
	{
		for (j = 0; OptionInt[i].vParamInt[j] != 999; j++)
		{
			...
			_stprintf(Heading,_T("Test Positive functionality of SQLSetStmtOptions for %s and ParamValue: %s\n"),
					...
					{					
						switch(OptionInt[i].fOption) 
						{
							...
							case SQL_MAX_LENGTH :
								...
								{
									InsTmp = (TCHAR *)malloc(MAX_NOS_SIZE);
									InsCol = (TCHAR *)malloc(MAX_NOS_SIZE);
									_tcscpy(InsCol,_T(""));
							...
							case SQL_ASYNC_ENABLE :
								switch(OptionInt[i].vParamInt[j]) 
								{
									...
									case SQL_ASYNC_ENABLE_ON :
										...
										while (returncode == SQL_STILL_EXECUTING)
										{
											returncode = SQLPrepare(hstmt,(SQLTCHAR*)ExecDirStr[0].CrtTab,SQL_NTS);
										...
										if (MX_MP_SPECIFIC == MX_SPECIFIC)
										{
											...
											while (returncode == SQL_STILL_EXECUTING)
											{
												...
												//if (returncode != SQL_ERROR)
												{
													...
													//LogMsg(ERRMSG,_T("Test unexpectedly succeeded while executing ASYNC call for SQLTABLEPRIVILEGES.\n"));
													LogAllErrors(henv,hdbc,hstmt);
												}
											}
											returncode = SQLFreeStmt(hstmt,SQL_CLOSE);
										...
										if (MX_MP_SPECIFIC == MX_SPECIFIC)
										{
											...
											while (returncode == SQL_STILL_EXECUTING)
											{
												...
												//if (returncode != SQL_ERROR)
												{
													...
													//LogMsg(ERRMSG,_T("Test unexpectedly succeeded while executing ASYNC call for SQLCOLUMNPRIVILEGES.\n"));
													LogAllErrors(henv,hdbc,hstmt);
												}
											}
											returncode = SQLFreeStmt(hstmt,SQL_CLOSE);
...
//==============================================================================================================
	...
	_stprintf(Heading,_T("Test Positive functionality of SQLGetStmtOption to test the NULL output\n"));
	TESTCASE_BEGINW(Heading);
...
//==============================================================================================================
	...
	_stprintf(Heading,_T("Test Negative functionality of SQLSetStmtOptions for SQL_ASYNC_ENABLE with invalid param\n"));
	TESTCASE_BEGINW(Heading);
...
//==============================================================================================================
	...
	_stprintf(Heading,_T("Test Negative functionality of SQLSetStmtOptions for invalid option\n"));
	TESTCASE_BEGINW(Heading);
...
//==============================================================================================================
	...
	_stprintf(Heading,_T("Test Negative functionality of SQLSetStmtOptions with invalid stmt handle\n"));
	TESTCASE_BEGINW(Heading);
...
//==============================================================================================================
	...
	_stprintf(Heading,_T("Test Negative functionality of SQLGetStmtOptions for invalid option\n"));
	TESTCASE_BEGINW(Heading);
...
//==============================================================================================================
	...
	_stprintf(Heading,_T("Test Negative functionality of SQLGetStmtOptions with invalid stmt handle\n"));
	TESTCASE_BEGINW(Heading);
...
//==============================================================================================================
	...
	LogMsg(SHORTTIMESTAMP+LINEAFTER,_T("End testing API => SQLSetStatement/GetStatement Option.\n"));
	free_list(var_list);
	TEST_RETURN;
}
