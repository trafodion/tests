...
#define	SQL_DATA_TYPES	19
#define	TYPE_LEN				128
#define	MAX_LEN					50
#define	NO_COLUMNS			13
/*
------------------------------------------------------------------
...
{   
	...
	struct
	{
		...
		{	//TYPENAME,		DATATYPE,		PREC,LITPRE,LITSUF,	PARAM,			NULL,			CASE,SRCH,				ATTR,MON,INC,LOC,		MIN,MAX
			...
			{_T("DATE"),		SQL_DATE,		10, _T("{d '"), _T("'}"),	_T(""),				SQL_NULLABLE,	0,	SQL_ALL_EXCEPT_LIKE,0,	0,	0,	_T("DATE"),		0,	0},
			{_T("TIME"),		SQL_TIME,		8,	_T("{t '"), _T("'}"),	_T(""),				SQL_NULLABLE,	0,	SQL_ALL_EXCEPT_LIKE,0,	0,	0,	_T("TIME"),		0,	0},
			{_T("TIMESTAMP"),	SQL_TIMESTAMP,	26, _T("{ts '"),_T("'}"),	_T(""),				SQL_NULLABLE,	0,	SQL_ALL_EXCEPT_LIKE,0,	0,	0,	_T("TIMESTAMP"),0,	6},
...
//			{_T("NCHAR VARYING"),SQL_WLONGVARCHAR,4018, _T("N'"),	_T("'"),	_T("max length"),				SQL_NULLABLE,	1,	SQL_SEARCHABLE,		0,	0,	0,	_T("WIDE LONG VARCHAR"),0,0},
			{_T("BINARY"),		SQL_BINARY,		4059, _T("'"),	_T("'"),	_T("max length"),	1,				0,	0,					0,	0,	0,	_T(""),			0,	0},
			{_T("VARBINARY"),	-3,				4059, _T("'"),	_T("'"),	_T("max length"),	1,				0,	0,					0,	0,	0,	_T(""),			0,	0},
			{_T("LONG VARBINARY"),-4,			4059,_T("'"),	_T("'"),	_T("max length"),	1,				0,	0,					0,	0,	0,	_T(""),			0,	0},
	...
	LogMsg(LINEBEFORE+SHORTTIMESTAMP,_T("Begin testing API =>SQLGetTypeInfo.\n"));
...
//=========================================================================================
	...
	while (TypeInfo[j].DATA_TYPE != END_LOOP) 
	{
		...
		LogMsg(NONE,_T("SQLGetTypeInfo(hstmt,%d\n"), TypeInfo[j].DATA_TYPE);
