...
//		char 						*OutputULintDef;
	...
	long long int			BigintDefOutput = 0;
...
// Negative tests to convert BIGNUM to all CTypes
	...
	char	*DrpTab10 = "DROP TABLE SQLGETDATA10";
	char	*CrtTab10 = "CREATE TABLE SQLGETDATA10 (C1 NUMERIC(128,64)) NO PARTITION";
	char	*InsTab10 = "INSERT INTO SQLGETDATA10 VALUES (123456789012345678901234567890.12345678901234567890123456789)";
	char	*SelTab10 = "SELECT * FROM SQLGETDATA10";
...
//===========================================================================================================
	var_list_t *var_list;
	var_list = load_api_vars("SQLGetData30", charset_file);
	if (var_list == NULL) return FAILED;

    i = 0;
    while (i < 8) {
        sprintf(temp,"SQLGetData30_DrpTab_%d",i);
        SQLStmt[i].DrpTab = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_CrtTab_%d",i);
        SQLStmt[i].CrtTab = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_InsTab_%d",i);
        SQLStmt[i].InsTab = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SelTab_%d",i);
    ...
    while (SQLDataValueTOC1[i].CType != 999) {
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_CrtCol_%d",i);
        SQLDataValueTOC1[i].CrtCol = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_InsCol_%d",i);
        SQLDataValueTOC1[i].InsCol = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_OutputValue0_%d",i);
        SQLDataValueTOC1[i].OutputValue[0] = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_OutputValue1_%d",i);
        SQLDataValueTOC1[i].OutputValue[1] = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_OutputValue14_%d",i);
        SQLDataValueTOC1[i].OutputValue[14] = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_OutputValue24_%d",i);
        SQLDataValueTOC1[i].OutputValue[24] = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_OutputValue25_%d",i);
        SQLDataValueTOC1[i].OutputValue[25] = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOC1_OutputValue26_%d",i);
        SQLDataValueTOC1[i].OutputValue[26] = var_mapping(temp, var_list);
        i++;
    }

	SQLDataValueTOC2A[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC2A_CrtCol_0", var_list);
	SQLDataValueTOC2A[1].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC2A_CrtCol_1", var_list);

	SQLDataValueTOC2B[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC2B_CrtCol_0", var_list);
	SQLDataValueTOC2B[1].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC2B_CrtCol_1", var_list);
	SQLDataValueTOC2B[2].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC2B_CrtCol_2", var_list);
	SQLDataValueTOC2B[3].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC2B_CrtCol_3", var_list);

	SQLDataValueTOC3A[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3A_CrtCol_0", var_list);
	SQLDataValueTOC3A[1].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3A_CrtCol_1", var_list);
	SQLDataValueTOC3A[2].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3A_CrtCol_2", var_list);
	SQLDataValueTOC3A[3].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3A_CrtCol_3", var_list);

	SQLDataValueTOC3B[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3B_CrtCol_0", var_list);

	SQLDataValueTOC3C[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3C_CrtCol_0", var_list);
	SQLDataValueTOC3C[1].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3C_CrtCol_1", var_list);
	SQLDataValueTOC3C[2].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3C_CrtCol_2", var_list);
	SQLDataValueTOC3C[3].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3C_CrtCol_3", var_list);

	SQLDataValueTOC3D[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC3D_CrtCol_0", var_list);

	SQLDataValueTOC4A[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC4A_CrtCol_0", var_list);
	SQLDataValueTOC4A[1].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC4A_CrtCol_1", var_list);

	SQLDataValueTOC4B[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC4B_CrtCol_0", var_list);
	SQLDataValueTOC4B[1].CrtCol = var_mapping("SQLGetData30_SQLDataValueTOC4B_CrtCol_1", var_list);

    i = 0;
    while(SQLDataValueTOCDef[i].CType != 999) {
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_CrtCol_%d",i);              
        SQLDataValueTOCDef[i].CrtCol = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_InsCol_%d",i);
        SQLDataValueTOCDef[i].InsCol = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_OutputCharDef_%d",i);
        SQLDataValueTOCDef[i].OutputCharDef = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_OutputVCharDef_%d",i);
        SQLDataValueTOCDef[i].OutputVCharDef = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_OutputLVCharDef_%d",i);
        SQLDataValueTOCDef[i].OutputLVCharDef = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_OutputNCharDef_%d",i);
        SQLDataValueTOCDef[i].OutputNCharDef = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_OutputNVCharDef_%d",i);
        SQLDataValueTOCDef[i].OutputNVCharDef = var_mapping(temp, var_list);
        sprintf(temp,"SQLGetData30_SQLDataValueTOCDef_OutputNLVCharDef_%d",i);
        SQLDataValueTOCDef[i].OutputNLVCharDef = var_mapping(temp, var_list);
        i++;
    }

	SQLDataValueforLessBuf[0].CrtCol = var_mapping("SQLGetData30_SQLDataValueforLessBuf_CrtCol_0", var_list);
	SQLDataValueforLessBuf[0].InsCol = var_mapping("SQLGetData30_SQLDataValueforLessBuf_InsCol_0", var_list);
	SQLDataValueforLessBuf[0].OutputValue[0] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue0_0", var_list);
	SQLDataValueforLessBuf[0].OutputValue[1] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue1_0", var_list);
	SQLDataValueforLessBuf[0].OutputValue[2] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue2_0", var_list);
    SQLDataValueforLessBuf[0].OutputValue[3] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue3_0", var_list);
	SQLDataValueforLessBuf[0].OutputValue[4] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue4_0", var_list);
	SQLDataValueforLessBuf[0].OutputValue[5] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue5_0", var_list);

	SQLDataValueforLessBuf[1].CrtCol = var_mapping("SQLGetData30_SQLDataValueforLessBuf_CrtCol_1", var_list);
	SQLDataValueforLessBuf[1].InsCol = var_mapping("SQLGetData30_SQLDataValueforLessBuf_InsCol_1", var_list);
	SQLDataValueforLessBuf[1].OutputValue[0] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue0_1", var_list);
	SQLDataValueforLessBuf[1].OutputValue[1] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue1_1", var_list);
	SQLDataValueforLessBuf[1].OutputValue[2] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue2_1", var_list);
    SQLDataValueforLessBuf[1].OutputValue[3] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue3_1", var_list);
	SQLDataValueforLessBuf[1].OutputValue[4] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue4_1", var_list);
	SQLDataValueforLessBuf[1].OutputValue[5] = var_mapping("SQLGetData30_SQLDataValueforLessBuf_OutputValue5_1", var_list);

	CFloatToNumeric[0].CrtCol = var_mapping("SQLGetData30_CFloatToNumeric_0", var_list);
	CFloatToNumeric[1].CrtCol = var_mapping("SQLGetData30_CFloatToNumeric_1", var_list);
	CFloatToNumeric[2].CrtCol = var_mapping("SQLGetData30_CFloatToNumeric_2", var_list);
	CFloatToNumeric[3].CrtCol = var_mapping("SQLGetData30_CFloatToNumeric_3", var_list);

	CDoubleToNumeric[0].CrtCol = var_mapping("SQLGetData30_CDoubleToNumeric_0", var_list);
	CDoubleToNumeric[1].CrtCol = var_mapping("SQLGetData30_CDoubleToNumeric_1", var_list);
	CDoubleToNumeric[2].CrtCol = var_mapping("SQLGetData30_CDoubleToNumeric_2", var_list);
	CDoubleToNumeric[3].CrtCol = var_mapping("SQLGetData30_CDoubleToNumeric_3", var_list);

    SQLUCS2ColTest[0].str = var_mapping("SQLGetData30_SQLUCS2ColTest_0", var_list);
    SQLUCS2ColTest[1].str = var_mapping("SQLGetData30_SQLUCS2ColTest_1", var_list);
    SQLUCS2ColTest[2].str = var_mapping("SQLGetData30_SQLUCS2ColTest_2", var_list);
    SQLUCS2ColTest[3].str = var_mapping("SQLGetData30_SQLUCS2ColTest_3", var_list);

    UCS2Input = var_mapping("SQLGetData30_UCS2Input", var_list);
...
//===========================================================================================================
	...
	LogMsg(LINEBEFORE+SHORTTIMESTAMP,"Begin testing API =>SQLGetData | SQLGetData30 | sqlgetdataver3.c\n");

	TEST_INIT;

	TESTCASE_BEGIN("Setup for SQLGetData Ver3 tests\n");
			...
			{  
				...
				switch (i)
				{
					...
					case 14:
						...
						break;
					case 15:
						if (SQLDataValueTOCDef[k].OutputBigintDef == BigintDefOutput)
						{
