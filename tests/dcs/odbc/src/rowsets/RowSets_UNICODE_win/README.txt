...
- The unix version of RowSets_UNICODE_unix is built and run from the unix build 
  structure.  See README.txt in the build strcuture for more details.

- To build the windows version
  (1) Go to RowSets_UNICODE_win\builds_win, click on RowSets.vs2005.vcproj, 
  ...
  (3) Build -> Rebuild Solution. 
      ...
      * 64-bit machine: RowSets_UNICODE_win\builds_win\UNICODE\x64
...
- To run the windows version
  ...
  (3) * Modify ..\..\env_win64.bat to have your dsn/usrid/password/charset.
      * ..\..\env_win64.bat
      * ..\..\run.bat
