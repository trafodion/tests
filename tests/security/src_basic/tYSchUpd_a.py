...
def test001(desc="""Y/Sh-Upd/U1,U2,U3 P:U2"""):
    global _testmgr
    global _testlist
    global _dci
...
def test002(desc="""Y/Sh-Upd/U1,U2,U3,R1 P:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test005(desc="""Y/Sh-Upd/U1,U2,U3,R1 P:U2,P:R1"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test006(desc="""Y/Sh-Upd/U1,U2,U3,R1 P:U2,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test007(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test012(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,P:R1"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test013(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,P:R2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test014(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test015(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test022(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,P:R1,P:R2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test023(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,P:R1,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test024(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,P:R1,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test025(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,P:R2,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test026(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,P:R2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test027(desc="""Y/Sh-Upd/U1,U2,U3,R1,R2 P:U2,R1:U2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
