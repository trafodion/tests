...
def test001(desc="""Y/Vwc-Upd/U1,U2,U3 P:PU"""):
    global _testmgr
    global _testlist
    global _dci
...
def test002(desc="""Y/Vwc-Upd/U1,U2,U3,R1 P:PU"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test005(desc="""Y/Vwc-Upd/U1,U2,U3,R1 P:PU,P:R1"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test006(desc="""Y/Vwc-Upd/U1,U2,U3,R1 P:PU,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test007(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test012(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,P:R1"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test013(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,P:R2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test014(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test015(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test022(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,P:R1,P:R2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test023(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,P:R1,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test024(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,P:R1,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test025(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,P:R2,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test026(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,P:R2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test027(desc="""Y/Vwc-Upd/U1,U2,U3,R1,R2 P:PU,R1:U2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
