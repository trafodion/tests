...
def test001(desc="""Y/Tb-Del/U1,U2,U3 P:U2"""):
    global _testmgr
    global _testlist
    global _dci
...
def test002(desc="""Y/Tb-Del/U1,U2,U3,R1,R2 P:R1"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test003(desc="""Y/Tb-Del/U1,U2,U3,R1,R2 R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test004(desc="""Y/Tb-Del/U1,U2,U3,R1,R2 P:R1,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test005(desc="""Y/Tb-Del/U1,U2,U3,R1,R2 P:U2,P:R1,P:R2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
