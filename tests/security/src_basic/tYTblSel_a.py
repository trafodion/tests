...
def test011(desc="""Y/Tb-Sel/U1,U2,U3,R1,R2 P:R2"""):
    global _testmgr
    global _testlist
    global _dci
...
def test012(desc="""Y/Tb-Sel/U1,U2,U3,R1,R2 P:U2,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test013(desc="""Y/Tb-Sel/U1,U2,U3,R1,R2 R1:U2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test014(desc="""Y/Tb-Sel/U1,U2,U3,R1,R2 P:U2,P:R2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
