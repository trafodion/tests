...
def _init(hptestmgr, testlist=[]):
    ...
    _testmgr.clone_dci_proc_with_id('qi_mxci6', _dci, TestVars.qi_user6, TestVars.qi_pw6, TestVars.qi_role6)

    mydci = switch_session_qi_user2()
    mydci = switch_session_qi_user4()
    mydci = switch_session_qi_user5()
    mydci = switch_session_qi_user6()
