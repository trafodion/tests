...
import tests.sequence.seqB01.tunit
import tests.sequence.seqH01.tunit
...
class TestSequence(unittest.TestCase):
    ...
    def test_seqB01(self):
        # == NO GLOBAL TABLES
        testlist = []
        self.run_testunit(tests.sequence.seqB01.tunit, testlist)
    def test_seqH01(self):
        # == NO GLOBAL TABLES
        testlist = []
        self.run_testunit(tests.sequence.seqH01.tunit, testlist)
