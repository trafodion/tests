...
import tests.session_values.values.tunit

class TestSessionValues(unittest.TestCase):
    """Legacy Regression Test: session_values"""
    ...
    def __init__(self, *args, **kwargs):
        super(TestSessionValues, self).__init__(*args, **kwargs)
        pass
    ...
    def test_values(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.session_values.values.tunit, testlist)

if __name__ == "__main__":
    #unittest.main()
    suite = unittest.TestLoader().loadTestsFromTestCase(TestSessionValues)
