...
def sq_testunit(hptestmgr, testlist=[]):
    ...
    hpdci.auto_execute_module_tests(cr8cjdate, hptestmgr, testlist)
    hpdci.auto_execute_module_tests(inscjdate, hptestmgr, testlist)
    ...
    hpdci.auto_execute_module_tests(t033, hptestmgr, testlist)
    hpdci.auto_execute_module_tests(t034, hptestmgr, testlist)
    hpdci.auto_execute_module_tests(t035, hptestmgr, testlist)
    hpdci.auto_execute_module_tests(t036, hptestmgr, testlist)
    hpdci.auto_execute_module_tests(t037, hptestmgr, testlist)
    hpdci.auto_execute_module_tests(t038, hptestmgr, testlist)
