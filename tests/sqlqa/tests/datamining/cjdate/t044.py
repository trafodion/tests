...
def test001(desc="""test044"""):
    ...
    # JClear
    # 2000-09-23
    # UNION of test004 (equijoin) and
    #          test005 (natural join)
    #          test006 (natural join with gt '>') and
    #          test007 (natural join with ne '<>')
    # CJDate tests 5th ed. pp 150-152
...
order by snum, pnum;"""
    ...
    # expect the following 16 rows in this order
