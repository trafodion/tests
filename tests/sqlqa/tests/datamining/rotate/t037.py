...
def test001(desc="""test037"""):
    ...
    stmt = """select keycol, valcol, count (*) as "Count" from flotxtab 
...
order by valcol, keycol;"""
    ...
    stmt = """select keycol, valcol, count (*) as "Count" from realxtab 
transpose b, c, d as valcol
key by keycol
group by keycol, valcol
order by valcol, keycol;"""
    ...
    stmt = """select keycol, valcol, count (*) as "Count" from dblxtab 
transpose b, c, d as valcol
key by keycol
group by keycol, valcol
order by valcol, keycol;"""
