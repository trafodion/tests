...
def test001(desc="""test014"""):
    ...
    # test014
    # Sequence function tests: test for RUNNINGMIN(column)
    #
    stmt = """select runningmin (i1) as runningmin_i1, i1
from vwseqtb2 sequence by ts;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test014.exp""", 's1')
    # expect two columns, one with all 1's, and the other with 1 - 20
...
from vwseqtb2 sequence by ts desc;"""
    ...
    # expect 2 columns of numbers 20 - 1
