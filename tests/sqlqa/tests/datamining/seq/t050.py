...
sequence by a;"""
    ...
    # expect movingsum at row 14 = 17653, 42 = 68313, 66 = 86331, 99 = 159492
...
sequence by a;"""
    ...
    # expect movingmax at row 13 = 4218, 33 = 11795, 66 = 22384, 82 = 26239
    # expect movingmin        13 = 2839, 33 = 11256, 66 = 20566, 82 = 24826
...
sequence by a;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test050.exp""", 's3')
    # expect movingsum at row 14 = 17653, 39 = 64511, 66 = 86331, 99 = 159492
    #      & mvavg at row 14 = 4413.25, 39 = 12902.2, 66 = 21582.75, 99 = 31898.4
...
sequence by a;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test050.exp""", 's4')
