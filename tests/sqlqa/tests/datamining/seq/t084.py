...
def test001(desc="""test084"""):
    ...
    # JClear
    # 1999-01-20
    # Sequence functions - natural right join : running functions
    #        runningcount
    #        runningsum
    #        runningmax
    #        runningmin
...
order by id;"""
    ...
    stmt = """select id, lname, doa, cast (pay as smallint) as pay,
...
order by id;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test084.exp""", 's3')
    # expect 20 rows
