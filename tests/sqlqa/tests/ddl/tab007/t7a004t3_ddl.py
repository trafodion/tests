...
--     primary key (double15_uniq,sbin17_uniq,  sbin14_1000, sdec16_uniq) not droppable -updated 20040329
--   primary key (double15_uniq,sbin17_uniq,  sbin14_1000, sdec16_uniq)  droppable
primary key (sbin17_uniq,  sbin14_1000, sdec16_uniq)
)
store by (sbin17_uniq, sbin14_1000, sdec16_uniq);"""
