...
# multi-column non-contiguous CLUSTERING primary key
# non-unique INTERVAL lead-off column
# 5000 recs
# formerly b2pwl26
...
dt1_yTOmin_4        Timestamp(0)    not null,
...
primary key (int1_ytom_100, sbin0_uniq, sbin17_uniq, ts13_uniq) not droppable    

)
store by (int1_yTOm_100, sbin0_uniq, sbin17_uniq, ts13_uniq);"""
