...
# unique lead-off column, non-contiguous primary key fields
# 5000 recs
# originally b2pwl04
...
date2_uniq          Date     not null not droppable,
...
sdec9_uniq          Decimal(18) signed  no default not null not droppable,
real9_n20           Real                               ,
time9_n4            Time                               ,
...
udec10_uniq         Decimal(9) unsigned no default not null not droppable,    
...
--  primary key (sdec9_uniq, sdec0_100 desc, sdec1_20) not droppable-20040329
