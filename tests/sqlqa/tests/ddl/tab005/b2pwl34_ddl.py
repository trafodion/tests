...
# all non-unique columns, non-contiguous primary key fields
# 5000 recs
...
# range partition (
# add first key (3,3,0) location """ + gvars.g_disc2 + """,
# add first key (6,3,0) location """ + gvars.g_disc3 + """
# )
# ;"""
