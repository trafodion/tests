...
# range partition
# (
# -- add first key 1.0200E1 location ${g_loc2},
# -- add first key 1.0100E3 location ${g_loc3}
# add first key 1 location """ + gvars.g_disc2 + """,
# add first key 10000 location """ + gvars.g_disc3 + """
# )
# ;"""
