...
# multi-column contiguous primary key
# unique TIMESTAMP lead-off column
# 5000 recs
...
ts1_uniq            Timestamp                       no default not null,
real1_100           Real                         not null,
...
-- primary key  (  ts1_uniq, real1_100) not droppable
-- udec10_uniq  Decimal(9) unsigned           no default not null,
-- udec11_2000  Decimal(9) unsigned           no default not null,
primary key  (  udec10_uniq, udec11_2000) not droppable
)
store by primary key
;"""
# location """ + gvars.g_disc1 + """
# range partition (
# -- add first key (timestamp '2100-01-01:00:31:14.625000',1)
# add first key (1,1)
# location """ + gvars.g_disc2 + """,
# -- add first key (timestamp '2100-01-01:01:02:29.250000',1000)
# add first key (10000,10000)
