...
import tests.atomicity.atom_mxci.tunit

class TestAtomicity(unittest.TestCase):
    """Regression Test: atomicity"""
    ...
    def __init__(self, *args, **kwargs):
        super(TestAtomicity, self).__init__(*args, **kwargs)
        pass
    ...
    def test_atom_mxci(self):
        # == NO GLOBAL TABLES
        testlist = []
        self.run_testunit(tests.atomicity.atom_mxci.tunit, testlist)


if __name__ == "__main__":
    #unittest.main()
    suite = unittest.TestLoader().loadTestsFromTestCase(TestAtomicity)
