...
;"""
    ...
    _dci.expect_file(output, defs.test_dir + """/test0455.exp""", """test0455a""")
...
;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0455.exp""", """test0455b""")
...
;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0455.exp""", """test0455c""")
