...
;"""
    ...
    _dci.expect_file(output, defs.test_dir + """/test0442.exp""", """test0442a""")
...
;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0442.exp""", """test0442b""")
    # PASS:0442 If 3 rows selected with PTYPE/CITY values(in any order):?
    # PASS:0442 Code/Vienna, Design/Deale, Test/Tampa?
...
;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0442.exp""", """test0442c""")
