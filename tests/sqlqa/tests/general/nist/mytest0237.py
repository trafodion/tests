...
WHERE CHARS18NAME18CHARS = 'VALU';"""
    ...
    _dci.expect_complete_msg(output)
    stmt = """SELECT *
---           FROM CANWEPARSELENGTH18.CHARACTERS18VIEW18;	XXXXX
FROM CHARACTERS18VIEW18;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0237.exp""", """test0237f""")
...
WHERE CORRELATIONNAMES18.CHARS18NAME18CHARS = 'VAL4';"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0237.exp""", """test0237g""")
