...
def _init(hptestmgr, testlist=[]):
    ...
    #    INSERT INTO HU.T100 VALUES ('00', '01', '02',	XXXXX
...
FROM T100;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0524.exp""", """test0524b""")
    ...
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0524.exp""", """test0524d""")
    # pass if count = 0
