...
where empnum = 'E1' or empnum = 'E3' or empnum = 'E5';"""
    ...
    stmt = """select distinct upper(user), grade
from   staff
order  by grade;"""
    output = _dci.cmdexec(stmt)
    ...
    # restore succeeded if 'E1' has 12, 'E3', and 'E5' have 13 each
    stmt = """select * from staff
order by EMPNUM;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0181.exp""", """test0181e""")
