...
def _init(hptestmgr, testlist=[]):
    ...
    stmt = """SELECT COUNT(*) FROM STAFF WHERE GRADE = 11;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0036.exp""", """test0036a""")
...
SET GRADE = 11;"""
    ...
    stmt = """SELECT COUNT(*) FROM STAFF WHERE GRADE = 11;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0036.exp""", """test0036c""")
    # PASS:0036 If count = 0?
