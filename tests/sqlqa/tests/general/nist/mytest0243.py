...
WHERE SMALLTEST = 9999;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0243.exp""", """test0243c""")
...
WHERE SMALLTEST = -9999;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0243.exp""", """test0243e""")
    ...
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0243.exp""", """test0243g""")
    # pass if count = 0
