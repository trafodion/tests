...
FROM WORKS;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0038.exp""", """test0038a""")
...
FROM WORKS;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0038.exp""", """test0038c""")
...
FROM WORKS;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/test0038.exp""", """test0038e""")
    # PASS:0038 If count = 12?
