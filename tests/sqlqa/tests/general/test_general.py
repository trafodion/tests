...
import tests.general.nist.tunit
import tests.general.nistvw.tunit
import tests.general.vals.tunit
import tests.general.querycancel.tunit

class TestGeneral(unittest.TestCase):
    """Legacy Regression Test: general"""
    ...
    def test_nist(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.general.nist.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_nistvw(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.general.nistvw.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_vals(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.general.vals.tunit, testlist)
    
    # @unittest.skip('skip this test')
    def test_querycancel(self):
        # == GLOBAL TABLES: g_tpch2x  
        testlist=[]
        self.run_testunit(tests.general.querycancel.tunit, testlist)
