...
import tests.querycache.hqc.tunit

class TestQuerycache(unittest.TestCase):
    """Legacy Regression Test: querycache"""
    ...
    def __init__(self, *args, **kwargs):
        super(TestQuerycache, self).__init__(*args, **kwargs)
        pass
    ...
    def test_hqc(self):
        # == no GLOBAL TABLES 
        testlist=[]
        self.run_testunit(tests.querycache.hqc.tunit, testlist)

if __name__ == "__main__":
    #unittest.main()
    suite = unittest.TestLoader().loadTestsFromTestCase(TestQuerycache)
