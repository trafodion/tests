...
def test001(desc="""create tables"""):
    ...
    # Create objects needed for testware leveraged from 1102:
...
, nsint smallint signed
    ...
    # Create objects needed for testware leveraged from 1103:
    
    # From arkt1103/preA14.
...
;"""
    ...
    #   ;
    #    select t1.vch7, t1.chu3, t2.vch7, t2.chu3, t3.vch7, t3.chu3
    #    from tab1 t1
    #    inner join tab2 t2 on t1.vch7 = t2.vch7
...
, '2_2:' || char2_2 || ' 3_4:' || char3_4 || ' 4_n10:' || char4_n10 ||
' 5_n20:' || char5_n20
