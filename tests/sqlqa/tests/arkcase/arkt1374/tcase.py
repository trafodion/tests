...
def test001(desc="""a01"""):
    ...
    stmt = """select [first 2] char_1,decimal_1 from """ + gvars.g_schema_arkcasedb + """.btsel01 
group by char_1,decimal_1
order by char_1,decimal_1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s0')
    
    stmt = """select [first 2] pic_x_1 from """ + gvars.g_schema_arkcasedb + """.btsel02 
group by pic_x_1
order by pic_x_1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s1')
    
    stmt = """select [first 2] pic_x_7,pic_9_7 from """ + gvars.g_schema_arkcasedb + """.btsel03 
group by pic_9_7,pic_x_7
order by pic_9_7,pic_x_7 ;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s2')
    
    stmt = """select [first 2] medium_int from """ + gvars.g_schema_arkcasedb + """.btsel04 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s3')
    
    stmt = """select [first 2] pic_x_b from """ + gvars.g_schema_arkcasedb + """.btsel05 
group by pic_x_b
order by pic_x_b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s4')
    
    stmt = """select [first 2] pic_x_a,col_1,col_3 from """ + gvars.g_schema_arkcasedb + """.btsel06 
...
order by pic_x_a,col_1,col_3;"""
    ...
    stmt = """select [first 2] pic_x_a from """ + gvars.g_schema_arkcasedb + """.btsel07 
group by pic_x_a
order by pic_x_a;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s8')
    
    stmt = """select [first 2] pic_1,large_int from """ + gvars.g_schema_arkcasedb + """.btsel08 
group by pic_1,large_int
order by pic_1,large_int;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s9')
    
    #  Order by should have all the col names in the select [first 2] list
    #  Testware correction made on oct22
    stmt = """select [first 2] large_int from """ + gvars.g_schema_arkcasedb + """.btsel08 
group by pic_1,large_int
order by large_int;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 2] pic_x_5 from """ + gvars.g_schema_arkcasedb + """.btsel09 
group by pic_x_5
order by pic_x_5;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s11')
    
    stmt = """select [first 2] binary_32_signed from """ + gvars.g_schema_arkcasedb + """.btsel10 
group by binary_32_signed
order by binary_32_signed;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s12')
    
    stmt = """select [first 2] decimal_10 from """ + gvars.g_schema_arkcasedb + """.btsel11 
group by decimal_10
order by decimal_10;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s13')
    
    stmt = """select [first 2] new_name_1 from """ + gvars.g_schema_arkcasedb + """.pvsel03 
group by new_name_1
order by new_name_1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s14')
    
    stmt = """select [first 2] new_name_1 from """ + gvars.g_schema_arkcasedb + """.svsel13 
group by new_name_1
order by new_name_1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a01exp""", 'a01s15')
    
    stmt = """select [first 2] SYSKEY
...
order by SYSKEY;"""
    ...
    stmt = """select [first 2] medium_int, binary_64_s, medium_int * binary_64_s
...
def test002(desc="""a02"""):
    ...
    #                      SELECT [first <N>] statements with JOIN
    ...
    stmt = """select [first 4] distinct pic_x_1,pic_x_7
...
order by pic_x_1,pic_x_7;"""
    ...
    stmt = """select [first 4] all pic_x_1,pic_x_7
from  """ + gvars.g_schema_arkcasedb + """.btsel02, """ + gvars.g_schema_arkcasedb + """.btsel03 
order by  """ + gvars.g_schema_arkcasedb + """.btsel02.syskey,  """ + gvars.g_schema_arkcasedb + """.btsel03.syskey;"""
    ...
    stmt = """select [first 4] distinct   """ + gvars.g_schema_arkcasedb + """.btsel02.*,pic_x_7,binary_32_u
from  """ + gvars.g_schema_arkcasedb + """.btsel02, """ + gvars.g_schema_arkcasedb + """.btsel03 
order by  """ + gvars.g_schema_arkcasedb + """.btsel02.pic_x_1,pic_x_7,binary_32_u;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s2')
    
    stmt = """select [first 4] all   """ + gvars.g_schema_arkcasedb + """.btsel02.*,pic_x_7,binary_32_u
from  """ + gvars.g_schema_arkcasedb + """.btsel02, """ + gvars.g_schema_arkcasedb + """.btsel03 
order by  """ + gvars.g_schema_arkcasedb + """.btsel02.syskey,  """ + gvars.g_schema_arkcasedb + """.btsel03.syskey;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s3')
    
    stmt = """select [first 4] distinct *
...
order by pic_x_1, pic_9_7 asc, pic_x_7 desc, pic_x_a asc;"""
    ...
    stmt = """select [first 4] all *
from  """ + gvars.g_schema_arkcasedb + """.btsel02, """ + gvars.g_schema_arkcasedb + """.btsel10 
order by syskey, pic_9_7 asc, pic_x_7 desc, pic_x_a asc;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s5')
    
    stmt = """select [first 4] distinct   """ + gvars.g_schema_arkcasedb + """.btsel02.*,  """ + gvars.g_schema_arkcasedb + """.btsel10.*
from  """ + gvars.g_schema_arkcasedb + """.btsel02, """ + gvars.g_schema_arkcasedb + """.btsel10 
order by pic_x_1, pic_9_7 asc, pic_x_7 desc, pic_x_a asc;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s6')
    
    stmt = """select [first 4] all   """ + gvars.g_schema_arkcasedb + """.btsel02.*,  """ + gvars.g_schema_arkcasedb + """.btsel10.*
from  """ + gvars.g_schema_arkcasedb + """.btsel02, """ + gvars.g_schema_arkcasedb + """.btsel10 
order by syskey, pic_9_7 asc, pic_x_7 desc, pic_x_a asc;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s7')
    
    stmt = """select [first 4] distinct new_name_3,pic_x_7
...
order by new_name_3,pic_x_7;"""
    ...
    stmt = """select [first 4] all new_name_3,pic_x_7
from  """ + gvars.g_schema_arkcasedb + """.pvsel03, """ + gvars.g_schema_arkcasedb + """.pvsel04 
order by new_name_4, pic_comp_1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s9')
    
    stmt = """select [first 4] distinct pic_x_b,pic_x_7
...
order by pic_x_b,pic_x_7;"""
    ...
    stmt = """select [first 4] all pic_x_b,pic_x_7
from  """ + gvars.g_schema_arkcasedb + """.btsel07, """ + gvars.g_schema_arkcasedb + """.pvsel04 
order by pic_x_c, pic_x_b, pic_x_a, pic_comp_1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s11')
    
    stmt = """select [first 4] distinct   """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_3,  """ + gvars.g_schema_arkcasedb + """.svsel13.new_name_3
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_3,  """ + gvars.g_schema_arkcasedb + """.svsel13.new_name_3;"""
    ...
    stmt = """select [first 4] all   """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_3,  """ + gvars.g_schema_arkcasedb + """.svsel13.new_name_3
from  """ + gvars.g_schema_arkcasedb + """.pvsel03, """ + gvars.g_schema_arkcasedb + """.svsel13 
order by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_4,  """ + gvars.g_schema_arkcasedb + """.svsel13.new_name_4;"""
    ...
    stmt = """select [first 4] distinct col_3
...
order by col_3;"""
    ...
    stmt = """select [first 4] all col_3
from  """ + gvars.g_schema_arkcasedb + """.svsel13, """ + gvars.g_schema_arkcasedb + """.svsel11 
order by new_name_4, col_4, col_8;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s15')
    
    stmt = """select [first 4] distinct firs.pic_x_1,secon.pic_x_1
...
order by firs.pic_x_1,secon.pic_x_1;"""
    ...
    stmt = """select [first 4] all firs.pic_x_1,secon.pic_x_1
from  """ + gvars.g_schema_arkcasedb + """.btsel02 firs, """ + gvars.g_schema_arkcasedb + """.btsel02 secon
order by firs.syskey, secon.syskey;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a02exp""", 'a02s17')
    
    stmt = """select [first 4] distinct firs.new_name_3,secon.new_name_3
...
order by firs.new_name_3,secon.new_name_3;"""
    ...
    stmt = """select [first 4] all firs.new_name_3,secon.new_name_3
from  """ + gvars.g_schema_arkcasedb + """.pvsel03 firs, """ + gvars.g_schema_arkcasedb + """.pvsel03 secon
...
order by firs.new_name_4, secon.new_name_4;"""
    ...
    stmt = """select [first 4] distinct pic_x_1,binary_64_s,medium_int
...
order by pic_x_1,binary_64_s,medium_int;"""
    ...
    stmt = """select [first 4] all pic_x_1,binary_64_s,medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel02,
 """ + gvars.g_schema_arkcasedb + """.btsel03,
 """ + gvars.g_schema_arkcasedb + """.btsel04 
...
def test003(desc="""a03"""):
    ...
    #  Description:        This test verifies the SQL SELECT
    #                      statement. Tests only normal (non-join &
    #                      non-subquery) select [first 1] statements, with
    #                      GROUP BY, HAVING & ORDER BY clauses &
    #                      some complex queries with all together
    #  Test case inputs:
    #  Test case outputs:
...
def test004(desc="""a04"""):
    ...
    #  Query 1
    stmt = """select [first 3] char_1, decimal_1
from """ + gvars.g_schema_arkcasedb + """.btsel01 
...
for serializable access;"""
    ...
    #  Query 2
    stmt = """select [first 3] distinct var_char,binary_64_s, pic_comp_1
from """ + gvars.g_schema_arkcasedb + """.btsel01 
where (char_1 like '%') and
(var_char in ('B','jimmy','thomas','marilyn','christopher'))
and (binary_32_u between 50 and 100) and
...
for serializable access;"""
    ...
    #  Order by should have all the cols in the select [first 3] list
    #  Testware correction made on oct 22
    #  Query 3
    stmt = """select [first 3] (new_name_1 * new_name_1), new_name_1, new_name_3
...
for read committed access;"""
    ...
    #  Query 4
    stmt = """select [first 3] new_name_1,new_name_4
...
for read uncommitted access;"""
    ...
    #  Query 5
    stmt = """select [first 3] medium_int,SYSKEY
from """ + gvars.g_schema_arkcasedb + """.btsel04 
...
order by medium_int,SYSKEY;"""
    ...
    #  Query 6
    stmt = """select [first 3] pic_x_b from """ + gvars.g_schema_arkcasedb + """.btsel05 
where col_1 = 'lowry'
group by pic_x_b
order by pic_x_b;"""
    output = _dci.cmdexec(stmt)
    ...
    #  Query 7
    stmt = """select [first 3] col_6, pic_x_a,col_1, pic_x_b, pic_x_c
...
order by pic_x_a,col_1, pic_x_b, pic_x_c;"""
    ...
    #  Query 8
    stmt = """select [first 3] pic_1,large_int from """ + gvars.g_schema_arkcasedb + """.btsel08 
where large_int >= 100
group by pic_1,large_int
...
order by pic_1,large_int;"""
    ...
    #  Query 9
    stmt = """select [first 3] pic_x_5 from """ + gvars.g_schema_arkcasedb + """.btsel09 
where pic_x_6 <> 11
group by pic_x_5
order by pic_x_5;"""
    output = _dci.cmdexec(stmt)
    ...
    #  Query 10
    stmt = """select [first 3] decimal_10 from """ + gvars.g_schema_arkcasedb + """.btsel10 
group by decimal_10
...
def test005(desc="""a05"""):
    ...
    stmt = """select [first 4] large_int from """ + gvars.g_schema_arkcasedb + """.btsel08 
group by large_int
for read uncommitted access
order by large_int;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 4] pic_x_5 from """ + gvars.g_schema_arkcasedb + """.btsel09 
group by pic_x_5
having pic_x_5 > 4
for read committed access
order by pic_x_5;"""
    ...
    stmt = """select [first 4] * from """ + gvars.g_schema_arkcasedb + """.btsel10 
...
for serializable access;"""
    ...
    stmt = """select [first 4] pic_x_b from """ + gvars.g_schema_arkcasedb + """.btsel05 
group by pic_x_b
for read committed access
order by pic_x_b;"""
    output = _dci.cmdexec(stmt)
...
order by pic_x_b;"""
    ...
    stmt = """select [first 4] * from """ + gvars.g_schema_arkcasedb + """.btsel05 
...
for read uncommitted access;"""
    ...
    stmt = """select [first 4] new_name_1 from """ + gvars.g_schema_arkcasedb + """.pvsel03 
group by new_name_1
for serializable access
order by new_name_1;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 4] new_name_1 from """ + gvars.g_schema_arkcasedb + """.svsel13 
group by new_name_1
for serializable access
order by new_name_1;"""
    output = _dci.cmdexec(stmt)
...
order by new_name_1;"""
    ...
    stmt = """select [first 4] * from """ + gvars.g_schema_arkcasedb + """.pvsel03 
order by new_name_1, new_name_4
for read committed access;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_selected_msg(output, 4)
    
    stmt = """select [first 4] * from """ + gvars.g_schema_arkcasedb + """.svsel13 
order by new_name_1, new_name_4
for read committed access;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_selected_msg(output, 4)
...
def test006(desc="""a06"""):
    ...
    #  Query 1
    stmt = """select [first 1] char_1, decimal_1
from """ + gvars.g_schema_arkcasedb + """.btsel01 
where (char_1 like '%') and
(var_char in ('B','jimmy','thomas','marilyn','christopher'))
and (binary_32_u between 50 and 100) and
...
for read uncommitted access;"""
    ...
    #  Query 4
    stmt = """select [first 1] distinct var_char,binary_64_s, pic_comp_1
from """ + gvars.g_schema_arkcasedb + """.btsel01 
where (char_1 like '%') and
(var_char in ('B','jimmy','thomas','marilyn','christopher'))
and (binary_32_u between 50 and 100) and
...
for serializable access;"""
    ...
    #  Query 7
    stmt = """select [first 1] new_name_1,new_name_4
from """ + gvars.g_schema_arkcasedb + """.svsel13 
where ((var_char like 'b%') or (var_char like 'tom')) and
(pic_comp_1 in (200,300,400,500)) and
(new_name_1 between 80 and 90)
...
for read uncommitted access;"""
    ...
    #  Query 8
    stmt = """select [first 1] medium_int,SYSKEY
from """ + gvars.g_schema_arkcasedb + """.btsel04 
where (medium_int > 200)
group by medium_int,SYSKEY
having medium_int in (999,1000,2000)
...
order by pic_x_b;"""
    ...
    #  Query 10
    stmt = """select [first 1]  col_6, pic_x_a,col_1, pic_x_b, pic_x_c
from """ + gvars.g_schema_arkcasedb + """.btsel06 
where col_6 < 90
order by pic_x_a,col_1, pic_x_b, pic_x_c;"""
    output = _dci.cmdexec(stmt)
    ...
    #  Query 11
    stmt = """select [first 1] pic_1,large_int
...
order by pic_x_5;"""
    ...
    #  Query 13
    stmt = """select [first 1] decimal_10
...
def test007(desc="""a07"""):
    ...
    stmt = """select [first 2] char_1 , decimal_1
from """ + gvars.g_schema_arkcasedb + """.btsel01 
where
( char_1 like '%')
and
...
for serializable access ;"""
    ...
    #       select [first 2] distinct var_char,binary_64_s, pic_comp_1
    #       from btsel01
    #       where (char_1 like '%') and
    #             (var_char in ('B','jimmy','thomas','marilyn','christopher'))
    #         and (binary_32_u between 50 and 100) and
    ...
    stmt = """select [first 2]                   (new_name_1*new_name_1), new_name_1, new_name_3
from                     """ + gvars.g_schema_arkcasedb + """.pvsel03 
where                    (new_name_1 between new_name_2 and 100) and
(new_name_3 in ('A','B','7')) and
(new_name_3 like '_') and
...
for read committed access;"""
    ...
    stmt = """select [first 2] new_name_1,new_name_4
FROM """ + gvars.g_schema_arkcasedb + """.svsel13 
WHERE ((var_char like 'b%') OR (var_char LIKE 'tom')) and
(pic_comp_1 IN (200,300,400,500)) AND
(new_name_1 BETWEEN 80 and 90)
...
for read uncommitted access;"""
    ...
    stmt = """select [first 2] medium_int,SYSKEY
from """ + gvars.g_schema_arkcasedb + """.btsel04 
where (medium_int > 200)
GROUP BY medium_int,SYSKEY
HAVING medium_int in (999,1000,2000)
...
order by PIC_X_B;"""
    ...
    stmt = """select [first 2] * from """ + gvars.g_schema_arkcasedb + """.btsel06 
where Col_6 < 90
order by pIc_X_a,cOL_1, pic_x_b, pic_x_c;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 2] pic_1,large_int
from """ + gvars.g_schema_arkcasedb + """.btsel08 
where large_int >= 100
group by pic_1,large_int
having large_int in (100,200,1000,2000)
order by pic_1, large_int;"""
    ...
    stmt = """select [first 2] pic_x_5 from """ + gvars.g_schema_arkcasedb + """.btsel09 where pic_x_6 <> 11
group by pic_x_5 order by pic_x_5;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a07exp""", 'a07s6')
    
    stmt = """select [first 2] decimal_10 from """ + gvars.g_schema_arkcasedb + """.btsel10 
group by decimal_10
...
def test008(desc="""a08"""):
    ...
    stmt = """select [first 1] binary_64_s,count(*)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
...
order by binary_64_s;"""
    ...
    stmt = """select [first 1] avg(large_int)
from """ + gvars.g_schema_arkcasedb + """.pvsel01 
group by medium_int;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_selected_msg(output, 1)
    
    stmt = """select [first 1] binary_64_s, pic_comp_1, min(ALL decimal_2_signed)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
...
order by binary_64_s,pic_comp_1;"""
    ...
    stmt = """select [first 1] new_name_2, sum(new_name_2)
from """ + gvars.g_schema_arkcasedb + """.pvsel03 
group by new_name_2
order by new_name_2;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] pic_comp_1,min(var_char)
from """ + gvars.g_schema_arkcasedb + """.svsel13 
group by pic_comp_1
order by pic_comp_1;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] pic_comp_1,AVG(distinct binary_32_u)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
group by pic_comp_1
order by pic_comp_1;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] new_name_1,count(distinct var_char)
from """ + gvars.g_schema_arkcasedb + """.svsel13 
group by new_name_1
order by new_name_1;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] binary_64_s, min(distinct var_char)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
group by binary_64_s
order by binary_64_s;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] binary_64_s, avg(ALL binary_32_u + pic_comp_1)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
group by binary_64_s
order by binary_64_s;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] medium_int, min(ALL large_int * small_int)
from """ + gvars.g_schema_arkcasedb + """.pvsel01 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] medium_int, min(ALL large_int * medium_int)
from """ + gvars.g_schema_arkcasedb + """.pvsel01 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] pic_x_7, max(SYSKEY / 3 + medium_int)
from """ + gvars.g_schema_arkcasedb + """.btsel04 
group by pic_x_7
order by pic_x_7;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] medium_int,(sum(pic_decimal_3) + sum(small_int)) / 100
from """ + gvars.g_schema_arkcasedb + """.pvsel01 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] medium_int,(sum(pic_decimal_3) + sum(medium_int)) / 100
from """ + gvars.g_schema_arkcasedb + """.pvsel01 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] pic_comp_1,avg(pic_comp_1 ) + sum(pic_comp_1)
from """ + gvars.g_schema_arkcasedb + """.svsel13 
group by pic_comp_1
order by pic_comp_1;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] medium_int,sum(decimal_1) + sum(decimal_1)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 1] medium_int,
...
order by binary_64_s;"""
    ...
    stmt = """select [first 1] pic_comp_1, SUM(distinct binary_64_s)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
...
order by new_name_1;"""
    ...
    stmt = """select [first 1] pic_comp_1, avg(ALL binary_32_u + pic_comp_1)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
where (pic_comp_1 <> 60)
group by pic_comp_1
order by pic_comp_1;"""
    ...
    stmt = """select [first 1] binary_64_s, sum(decimal_1) + sum(decimal_1)
from """ + gvars.g_schema_arkcasedb + """.btsel01 
...
order by binary_64_s;"""
    ...
    stmt = """select [first 1] medium_int,avg(large_int)
from """ + gvars.g_schema_arkcasedb + """.pvsel01 
...
order by medium_int;"""
    ...
    #  select [first 1] aggregate, group by SYSKEY
    
    stmt = """select [first 1] avg(pic_comp_1)
from """ + gvars.g_schema_arkcasedb + """.btsel04 
group by SYSKEY;"""
    output = _dci.cmdexec(stmt)
...
having min(small_int) <= 10;"""
    ...
    stmt = """select [first 1] sum(col_4)
from """ + gvars.g_schema_arkcasedb + """.svsel11 
having count(*) = 8;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_selected_msg(output, 0)
    
    # test select [first 1] from 0 groups
    
    stmt = """select [first 1] max(binary_64_s), min(binary_64_s)
from """ + gvars.g_schema_arkcasedb + """.btsel03 
group by pic_9_7
having pic_9_7 > 200;"""
    output = _dci.cmdexec(stmt)
...
order by binary_64_s;"""
    ...
    stmt = """select [first 1] binary_64_s
from """ + gvars.g_schema_arkcasedb + """.btsel01 
group by binary_64_s
having sum(binary_64_s) > 2000
order by binary_64_s;"""
...
order by pic_comp_1;"""
    ...
    stmt = """select [first 1] new_name_1
from """ + gvars.g_schema_arkcasedb + """.svsel13 
group by new_name_1
...
order by pic_comp_1;"""
    ...
    stmt = """select [first 1] binary_64_s, sum(decimal_1) + sum(decimal_1), pic_comp_2
from """ + gvars.g_schema_arkcasedb + """.btsel01 
where decimal_3_unsigned <> 110
...
for read uncommitted access;"""
    ...
    #  select [first 1] having aggregate(SYSKEY)
    
    stmt = """select [first 1] pic_comp_1
from """ + gvars.g_schema_arkcasedb + """.btsel04 
group by pic_comp_1
having avg(SYSKEY) > 0
order by pic_comp_1;"""
...
def test010(desc="""a10"""):
    ...
    stmt = """select [first 1] char_1,decimal_1 from """ + gvars.g_schema_arkcasedb + """.btsel01 
group by  char_1,decimal_1
order by  1,2;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a10exp""", 'a10s0')
    
    stmt = """select [first 1] pic_x_1 from """ + gvars.g_schema_arkcasedb + """.btsel02 
group by pic_x_1
order by 1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a10exp""", 'a10s1')
    
    stmt = """select [first 1] pic_x_7,pic_9_7 from """ + gvars.g_schema_arkcasedb + """.btsel03 
group by pic_9_7, pic_x_7
order by 2,1;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a10exp""", 'a10s2')
    
    stmt = """select [first 1] pic_x_a,col_1,col_3 from """ + gvars.g_schema_arkcasedb + """.btsel06 
group by pic_x_a, col_1, col_1, col_3
order by 1, 2, 3;"""
    output = _dci.cmdexec(stmt)
...
order by 1,2;"""
    ...
    stmt = """select [first 1] dt.a, dt.b from
...
order by 1;"""
    ...
    stmt = """select [first 1] dt.x, dt.y from
...
order by 1;"""
    ...
    # result is un-deterministic due to subquery is not sorted
    stmt = """select [first 1] x, y from
...
;"""
    ...
    stmt = """select [first 3] * from svsel20 
...
select b from ptiletab ;"""
    ...
    # - Positive tests
    stmt = """select [first 6] b, ptile (b,50) from ptiletab group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    stmt = """select [first 6] b, ptile (b,90) from ptiletab group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    stmt = """select [first 6] a,b,ptile (b,10) from ptiletab group by a,b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    
    stmt = """select [first 6] b, ptile (b,50) from ptilevw group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    stmt = """select [first 6] b, ptile (b,90) from ptilevw group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    
    # - Negative tests
    stmt = """select [first 6] b, ptile (b,0) from ptiletab group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    stmt = """select [first 6] b, ptile (b,-10) from ptiletab group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    stmt = """select [first 6] a,b,ptile (b,100) from ptiletab group by a,b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    
    stmt = """select [first 6] b, ptile (b,0) from ptilevw group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    stmt = """select [first 6] b, ptile (b,-10) from ptilevw group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
    stmt = """select [first 6] b, ptile (b,100) from ptilevw group by b;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_error_msg(output)
