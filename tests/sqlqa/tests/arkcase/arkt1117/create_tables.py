...
def test001(desc="""create tables"""):
    ...
    stmt = """CREATE TABLE LINEITEM (L_ORDERKEY INTEGER NOT NULL NOT DROPPABLE,
...
store by primary key ;"""
    ...
    stmt = """CREATE TABLE ORDERS (O_ORDERKEY INTEGER NOT NULL NOT DROPPABLE,
...
credits  int
, part_col varchar(5)    not null
, primary key (part_col) NOT DROPPABLE
...
dept_num    int,
str         varchar(2)
-- Add partitioning column for partitioned version of tests.
, part_col varchar(5)    not null
, primary key (part_col) NOT DROPPABLE
) number of partitions 2
;"""
...
-- 04/23/09 remove range partition, use POS hash partition
--   LOCATION ${w_partt1}
--   PARTITION ( ADD first key
