...
order by pic_9_7;"""
    ...
    # Query 2
    stmt = """select [first 2] medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
...
order by medium_int;"""
    ...
    # Query 4
    stmt = """select [first 2] pic_9_7, """ + gvars.g_schema_arkcasedb + """.btsel03.pic_x_7
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
...
order by pic_9_7, """ + gvars.g_schema_arkcasedb + """.btsel03.pic_x_7;"""
    ...
    # Query 5
    stmt = """select [first 2] pic_9_7,medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
...
order by pic_9_7,medium_int;"""
    ...
    # Query 6
    stmt = """select [first 2] pic_x_1,pic_9_7,medium_int
...
order by pic_x_1,pic_9_7,medium_int;"""
    ...
    # Query 7
    stmt = """select [first 2] decimal_1,new_name_1
...
order by decimal_1,new_name_1;"""
    ...
    # Query 9
    stmt = """select [first 2]  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int;"""
    ...
    # Query 10
    stmt = """select [first 2]  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int;"""
    ...
    # Query 11
    stmt = """select [first 2] new_name_3,col_3
...
order by new_name_3,col_3;"""
    ...
    # Query 12
    stmt = """select [first 2] secon.char_1, f.medium_int
...
order by secon.char_1,f.medium_int;"""
    ...
    # Query 13
    stmt = """select [first 2] secon.medium_int
...
order by secon.medium_int;"""
    ...
    # Query 14
    stmt = """select [first 2] f.new_name_1,f.new_name_3
...
order by pic_9_7;"""
    ...
    stmt = """select [first 3] medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
group by medium_int
...
order by medium_int;"""
    ...
    stmt = """select [first 3] pic_9_7, """ + gvars.g_schema_arkcasedb + """.btsel03.pic_x_7
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
group by pic_9_7, """ + gvars.g_schema_arkcasedb + """.btsel03.pic_x_7
...
order by pic_9_7, """ + gvars.g_schema_arkcasedb + """.btsel03.pic_x_7;"""
    ...
    stmt = """select [first 3] pic_9_7,medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
group by pic_9_7,medium_int
...
order by pic_9_7,medium_int;"""
    ...
    stmt = """select [first 3] pic_x_1,pic_9_7,medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel02,
 """ + gvars.g_schema_arkcasedb + """.btsel03,
 """ + gvars.g_schema_arkcasedb + """.btsel04 
group by pic_x_1,pic_9_7,medium_int
...
order by pic_x_1,pic_9_7,medium_int;"""
    ...
    stmt = """select [first 3] decimal_1,new_name_1
from  """ + gvars.g_schema_arkcasedb + """.btsel01, """ + gvars.g_schema_arkcasedb + """.pvsel03 
group by decimal_1,new_name_1
...
order by decimal_1,new_name_1;"""
    ...
    # test select [first 3] from 0 groups
...
order by decimal_1,new_name_1;"""
    ...
    stmt = """select [first 3]  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int
from  """ + gvars.g_schema_arkcasedb + """.pvsel01, """ + gvars.g_schema_arkcasedb + """.pvsel04 
group by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int;"""
    ...
    stmt = """select [first 3]  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int
from  """ + gvars.g_schema_arkcasedb + """.pvsel01, """ + gvars.g_schema_arkcasedb + """.svsel13 
group by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int;"""
    ...
    stmt = """select [first 3] new_name_3,col_3
from  """ + gvars.g_schema_arkcasedb + """.svsel13, """ + gvars.g_schema_arkcasedb + """.svsel11 
group by new_name_3,col_3
...
order by new_name_3,col_3;"""
    ...
    stmt = """select [first 3] secon.char_1, f.medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel01 f,  """ + gvars.g_schema_arkcasedb + """.btsel01 secon
group by secon.char_1,f.medium_int
...
order by secon.char_1,f.medium_int;"""
    ...
    stmt = """select [first 3] secon.medium_int
from  """ + gvars.g_schema_arkcasedb + """.pvsel01 f,  """ + gvars.g_schema_arkcasedb + """.pvsel01 secon
group by secon.medium_int
...
order by secon.medium_int;"""
    ...
    stmt = """select [first 3] f.new_name_1,f.new_name_3
from  """ + gvars.g_schema_arkcasedb + """.svsel13 f, """ + gvars.g_schema_arkcasedb + """.svsel13 secon
group by f.new_name_1,f.new_name_3
...
order by 4,6, """ + gvars.g_schema_arkcasedb + """.btsel03.syskey, """ + gvars.g_schema_arkcasedb + """.btsel04.syskey;"""
    ...
    stmt = """select [first 16] pic_x_1,pic_9_7,medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel02,
 """ + gvars.g_schema_arkcasedb + """.btsel03,
 """ + gvars.g_schema_arkcasedb + """.btsel04 
order by pic_x_1,pic_9_7,medium_int ASC;"""
    ...
    stmt = """select [first 16] decimal_1,new_name_1
from  """ + gvars.g_schema_arkcasedb + """.btsel01, """ + gvars.g_schema_arkcasedb + """.pvsel03 
...
order by decimal_1,new_name_1;"""
    ...
    stmt = """select [first 16] """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int
from  """ + gvars.g_schema_arkcasedb + """.pvsel01, """ + gvars.g_schema_arkcasedb + """.pvsel04 
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int DESC,
 """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int DESC;"""
    ...
    stmt = """select [first 16] """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int
from  """ + gvars.g_schema_arkcasedb + """.pvsel01, """ + gvars.g_schema_arkcasedb + """.svsel13 
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a03exp""", 'a03s7')
    
    stmt = """select [first 16] new_name_3, col_3
from  """ + gvars.g_schema_arkcasedb + """.svsel13, """ + gvars.g_schema_arkcasedb + """.svsel11 
order by new_name_3,col_3;"""
    output = _dci.cmdexec(stmt)
    _dci.expect_file(output, defs.test_dir + """/a03exp""", 'a03s8')
    
    stmt = """select [first 16] firs.medium_int, secon.char_1
...
order by secon.char_1 DESC, firs.medium_int ASC;"""
    ...
    stmt = """select [first 16] secon.medium_int
...
order by secon.medium_int;"""
    ...
    # 	*************** Test A03.12
    stmt = """select [first 16] firs.new_name_3, firs.new_name_1
...
def test004(desc="""a04"""):
    ...
    stmt = """select [first 4] pic_9_7,medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
...
for read uncommitted access;"""
    ...
    stmt = """select [first 4] pic_x_1,pic_9_7,medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel02,
 """ + gvars.g_schema_arkcasedb + """.btsel03,
 """ + gvars.g_schema_arkcasedb + """.btsel04 
...
for read committed access;"""
    ...
    stmt = """select [first 4] decimal_1,new_name_1
from  """ + gvars.g_schema_arkcasedb + """.btsel01, """ + gvars.g_schema_arkcasedb + """.pvsel03 
...
order by decimal_1,new_name_1;"""
    ...
    stmt = """select [first 4]  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int
from   """ + gvars.g_schema_arkcasedb + """.pvsel01, """ + gvars.g_schema_arkcasedb + """.pvsel04 
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int, """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int;"""
    ...
    stmt = """select [first 4]  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int
from  """ + gvars.g_schema_arkcasedb + """.pvsel01, """ + gvars.g_schema_arkcasedb + """.svsel13 
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int;"""
    ...
    stmt = """select [first 4] new_name_3,col_3
from  """ + gvars.g_schema_arkcasedb + """.svsel13, """ + gvars.g_schema_arkcasedb + """.svsel11 
...
order by new_name_3,col_3;"""
    ...
    stmt = """select [first 4] secon.char_1,f.medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel01 f, """ + gvars.g_schema_arkcasedb + """.btsel01 secon
...
for read uncommitted access;"""
    ...
    stmt = """select [first 16] secon.char_1,f.medium_int
from  """ + gvars.g_schema_arkcasedb + """.btsel01 f,  """ + gvars.g_schema_arkcasedb + """.btsel01 secon
group by secon.char_1,f.medium_int
for serializable access
order by secon.char_1,f.medium_int;"""
...
def test006(desc="""a06"""):
    ...
    stmt = """select [first 2] medium_int, count(*)
from  """ + gvars.g_schema_arkcasedb + """.btsel03, """ + gvars.g_schema_arkcasedb + """.btsel04 
group by medium_int
order by medium_int;"""
    output = _dci.cmdexec(stmt)
...
order by medium_int;"""
    ...
    stmt = """select [first 2] binary_64_s, """ + gvars.g_schema_arkcasedb + """.pvsel04.pic_comp_1,min(ALL decimal_2_signed)
...
order by binary_64_s,  """ + gvars.g_schema_arkcasedb + """.pvsel04.pic_comp_1;"""
    ...
    stmt = """select [first 2]  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2, sum( """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2)
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2;"""
    ...
    stmt = """select [first 2]  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2, sum( """ + gvars.g_schema_arkcasedb + """.svsel13.new_name_2)
from  """ + gvars.g_schema_arkcasedb + """.pvsel03,  """ + gvars.g_schema_arkcasedb + """.svsel13 
group by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2
order by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 2] """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1, count(distinct  """ + gvars.g_schema_arkcasedb + """.svsel13.var_char)
...
order by  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1;"""
    ...
    stmt = """select [first 2] """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1, count(distinct  """ + gvars.g_schema_arkcasedb + """.btsel01.var_char)
from  """ + gvars.g_schema_arkcasedb + """.svsel13,  """ + gvars.g_schema_arkcasedb + """.btsel01 
group by  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1
order by  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = """select [first 2]  """ + gvars.g_schema_arkcasedb + """.btsel01.medium_int,
...
order by  """ + gvars.g_schema_arkcasedb + """.btsel01.medium_int;"""
    ...
    stmt = """select [first 2] f.pic_comp_1, avg(f.pic_comp_1) + sum(s.pic_comp_1)
...
order by f.pic_comp_1;"""
    ...
    stmt = """select [first 2] f.binary_64_s, count(*)
...
order by f.binary_64_s;"""
    ...
    stmt = """select [first 2] large_int, count(*)
from  """ + gvars.g_schema_arkcasedb + """.btsel01,  """ + gvars.g_schema_arkcasedb + """.pvsel04 
...
order by large_int;"""
    ...
    stmt = """select [first 2]  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1, avg(decimal_1)
from  """ + gvars.g_schema_arkcasedb + """.svsel13,  """ + gvars.g_schema_arkcasedb + """.btsel01 
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int;"""
    ...
    stmt = """select [first 2] pic_9_7, sum(binary_32_u + pic_comp_1)
from  """ + gvars.g_schema_arkcasedb + """.btsel03,  """ + gvars.g_schema_arkcasedb + """.btsel04 
...
order by pic_9_7;"""
    ...
    stmt = """select [first 2] pic_comp_1, avg(col_7) * sum(pic_comp_1)
from  """ + gvars.g_schema_arkcasedb + """.svsel13,  """ + gvars.g_schema_arkcasedb + """.svsel11 
...
def test007(desc="""a07"""):
    ...
    stmt = """select [first 1] sum(pic_decimal_2), max( """ + gvars.g_schema_arkcasedb + """.pvsel04.var_char)
from  """ + gvars.g_schema_arkcasedb + """.btsel01, """ + gvars.g_schema_arkcasedb + """.pvsel04 
...
avg( """ + gvars.g_schema_arkcasedb + """.pvsel04.pic_comp_1) > 1000;"""
    ...
    stmt = """select [first 1] f.binary_64_s, count(*)
from  """ + gvars.g_schema_arkcasedb + """.btsel01 f,  """ + gvars.g_schema_arkcasedb + """.btsel01 s
group by f.binary_64_s
...
having sum(ALL f.large_int) > 0;"""
    ...
    stmt = """select [first 1] binary_64_s, """ + gvars.g_schema_arkcasedb + """.pvsel04.pic_comp_1,min(ALL decimal_2_signed)
from  """ + gvars.g_schema_arkcasedb + """.btsel01,  """ + gvars.g_schema_arkcasedb + """.pvsel04 
group by binary_64_s,  """ + gvars.g_schema_arkcasedb + """.pvsel04.pic_comp_1
...
order by binary_64_s,  """ + gvars.g_schema_arkcasedb + """.pvsel04.pic_comp_1;"""
    ...
    stmt = """select [first 1]  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2, sum( """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2)
from  """ + gvars.g_schema_arkcasedb + """.pvsel03,  """ + gvars.g_schema_arkcasedb + """.svsel13 
group by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2;"""
    ...
    stmt = """select [first 1]  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2, sum( """ + gvars.g_schema_arkcasedb + """.svsel13.new_name_2)
from  """ + gvars.g_schema_arkcasedb + """.pvsel03,  """ + gvars.g_schema_arkcasedb + """.svsel13 
group by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel03.new_name_2;"""
    ...
    stmt = """select [first 1] """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1, count(distinct  """ + gvars.g_schema_arkcasedb + """.svsel13.var_char)
from  """ + gvars.g_schema_arkcasedb + """.svsel13,  """ + gvars.g_schema_arkcasedb + """.btsel01 
group by  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1
...
order by  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1;"""
    ...
    stmt = """select [first 1] """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1, count(distinct """ + gvars.g_schema_arkcasedb + """.btsel01.var_char)
from  """ + gvars.g_schema_arkcasedb + """.svsel13,  """ + gvars.g_schema_arkcasedb + """.btsel01 
group by """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1
...
order by """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1;"""
    ...
    stmt = """select [first 1] """ + gvars.g_schema_arkcasedb + """.btsel01.binary_64_s, avg(ALL binary_32_u +  """ + gvars.g_schema_arkcasedb + """.btsel04.pic_comp_1)
...
order by  """ + gvars.g_schema_arkcasedb + """.btsel01.binary_64_s;"""
    ...
    stmt = """select [first 1]  """ + gvars.g_schema_arkcasedb + """.btsel01.medium_int,
min(ALL  """ + gvars.g_schema_arkcasedb + """.pvsel01.large_int *  """ + gvars.g_schema_arkcasedb + """.btsel01.medium_int)
from  """ + gvars.g_schema_arkcasedb + """.pvsel01,  """ + gvars.g_schema_arkcasedb + """.btsel01 
group by  """ + gvars.g_schema_arkcasedb + """.btsel01.medium_int
...
order by  """ + gvars.g_schema_arkcasedb + """.btsel01.medium_int;"""
    ...
    stmt = """select [first 1] large_int, count(*)
from  """ + gvars.g_schema_arkcasedb + """.btsel01,  """ + gvars.g_schema_arkcasedb + """.pvsel04 
where  """ + gvars.g_schema_arkcasedb + """.btsel01.large_int =  """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int
group by large_int
...
order by large_int;"""
    ...
    stmt = """select [first 1]  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1, avg(decimal_1)
from  """ + gvars.g_schema_arkcasedb + """.svsel13,  """ + gvars.g_schema_arkcasedb + """.btsel01 
where decimal_3_unsigned = new_name_1
group by  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1
...
order by  """ + gvars.g_schema_arkcasedb + """.svsel13.pic_comp_1;"""
    ...
    stmt = """select [first 1]  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int,
avg(distinct  """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int)
from  """ + gvars.g_schema_arkcasedb + """.pvsel01,  """ + gvars.g_schema_arkcasedb + """.pvsel04 
where  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int >  """ + gvars.g_schema_arkcasedb + """.pvsel04.medium_int
group by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int
...
order by  """ + gvars.g_schema_arkcasedb + """.pvsel01.medium_int;"""
    ...
    stmt = """select [first 1] pic_9_7, sum(binary_32_u + pic_comp_1)
from  """ + gvars.g_schema_arkcasedb + """.btsel03,  """ + gvars.g_schema_arkcasedb + """.btsel04 
where pic_comp_1 in (medium_int, binary_64_s)
group by pic_9_7
...
order by pic_9_7;"""
    ...
    stmt = """select [first 1] pic_comp_1, avg(col_7) * sum(pic_comp_1)
from  """ + gvars.g_schema_arkcasedb + """.svsel13,  """ + gvars.g_schema_arkcasedb + """.svsel11 
where new_name_3 = col_8
group by pic_comp_1
