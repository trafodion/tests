...
import tests.addcolperf.addt101.tunit
import tests.addcolperf.addt102.tunit
import tests.addcolperf.addt103.tunit

class TestAddcolperf(unittest.TestCase):
    """Regression Test: addcolperf"""
    ...
    def test_addt101(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.addcolperf.addt101.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_addt102(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.addcolperf.addt102.tunit, testlist)
    
    # @unittest.skip('skip this test')
    def test_addt103(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.addcolperf.addt103.tunit, testlist)
