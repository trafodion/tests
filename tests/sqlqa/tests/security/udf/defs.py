...
my_schema= 'SECURITY_UDF'
# Add additional variables here.

# set SPJ library & procedure

sec_libname1 = 'sec_udflib1'
sec_libname2 = 'sec_udflib2'
sec_udflib1= 'SECURITY_UDF.' + sec_libname1
sec_udflib2= 'SECURITY_UDF.' + sec_libname2


# set so file location
spjroot = '/home/trafodion'			# this location needs to be reset for test cluster
#spjroot = '/opt/home/chenjuan/trafodion/sqltests/tests/security/udf/udf_h'

spjpath = spjroot + '/secudf.dll'
spjpathrs = spjroot + '/secudf_rs.so'
