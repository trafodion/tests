...
def test015(desc="""Y/Tb-Upd/U1,U2,U3,R1 P:U2,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
...
def test016(desc="""Y/Tb-Upd/U1,U2,U3,R1,R2 R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test017(desc="""Y/Tb-Upd/U1,U2,U3,R1,R2 P:R2,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test018(desc="""Y/Tb-Upd/U1,U2,U3,R1,R2 P:R1,R1:U2,R2:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
