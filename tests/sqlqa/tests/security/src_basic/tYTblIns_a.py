...
def test006(desc="""Y/Tb-Ins/U1,U2,U3,R1 P:U2"""):
    global _testmgr
    global _testlist
    global _dci
...
def test007(desc="""Y/Tb-Ins/U1,U2,U3,R1,R2 P:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test008(desc="""Y/Tb-Ins/U1,U2,U3,R1,R2 P:U2,P:R1"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test009(desc="""Y/Tb-Ins/U1,U2,U3,R1,R2 P:R1,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
def test010(desc="""Y/Tb-Ins/U1,U2,U3,R1,R2 P:U2,P:R1,R1:U2"""):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
