...
stringu1        char(52)        casespecific not null not droppable,
stringu2        char(52)        casespecific not null not droppable,
string4         char(52)        casespecific not null not droppable
);"""
    output = _dci.cmdexec(stmt)
