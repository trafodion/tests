...
def _init(hptestmgr, testlist=[]):
    ...
    stmt = """control query default POS_NUM_OF_PARTNS '512';"""
    output = _dci.cmdexec(stmt)
    
    stmt = """Create Table """ + defs.my_schema + """.pd182 (
char0_n10           Character(2) default 'AD' heading 'char0_n10 with default AD',
...
location """ + gvars.g_disc1 + """;"""
    ...
    stmt = """showlabel """ + defs.my_schema + """.pd182, detail;"""
    output = _dci.cmdexec(stmt)
