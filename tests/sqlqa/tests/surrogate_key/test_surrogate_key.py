...
import tests.surrogate_key.always.tunit
import tests.surrogate_key.default.tunit

class TestSqFixes(unittest.TestCase):
    """Legacy Regression Test: surrogate_key"""
    ...
    def __init__(self, *args, **kwargs):
        super(TestSqFixes, self).__init__(*args, **kwargs)
        pass
    ...
    def test_always(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.surrogate_key.always.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_default(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.surrogate_key.default.tunit, testlist)

if __name__ == "__main__":
    #unittest.main()
    suite = unittest.TestLoader().loadTestsFromTestCase(TestSqFixes)
