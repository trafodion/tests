...
import tests.minmax.mmop001.tunit
import tests.minmax.mmop002.tunit
import tests.minmax.mmop003.tunit

class TestMinmax(unittest.TestCase):
    """Legacy Regression Test: minmax"""
    ...
    def __init__(self, *args, **kwargs):
        super(TestMinmax, self).__init__(*args, **kwargs)
        pass
    ...
    def test_mmop001(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.minmax.mmop001.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_mmop002(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.minmax.mmop002.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_mmop003(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.minmax.mmop003.tunit, testlist)
