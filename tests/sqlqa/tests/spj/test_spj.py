...
import tests.spj.spj.tunit
import tests.spj.spjrs.tunit

class TestSPJ(unittest.TestCase):
    """Regression Test: SPJ"""
    ...
    def __init__(self, *args, **kwargs):
        super(TestSPJ, self).__init__(*args, **kwargs)
        pass
    ...
    def test_spj(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.spj.spj.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_spjrs(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.spj.spjrs.tunit, testlist)

if __name__ == "__main__":
    #unittest.main()
    suite = unittest.TestLoader().loadTestsFromTestCase(TestSPJ)
