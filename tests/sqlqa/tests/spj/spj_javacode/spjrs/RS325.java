...
public class RS325
{
  ...
  public static void RS325(ResultSet[] paramArrayOfResultSet)
    throws Exception
  {
  ...
  public static void RS325a(ResultSet[] paramArrayOfResultSet1, ResultSet[] paramArrayOfResultSet2, ResultSet[] paramArrayOfResultSet3, ResultSet[] paramArrayOfResultSet4, ResultSet[] paramArrayOfResultSet5, ResultSet[] paramArrayOfResultSet6, ResultSet[] paramArrayOfResultSet7, ResultSet[] paramArrayOfResultSet8, ResultSet[] paramArrayOfResultSet9, ResultSet[] paramArrayOfResultSet10)
    throws Exception
  {
    String str1 = "jdbc:default:connection";
  ...
  public static void RS331(ResultSet[] paramArrayOfResultSet1, ResultSet[] paramArrayOfResultSet2)
    throws Exception
  {
    String str1 = "jdbc:default:connection";
    ...
    String str3 = "select * from d4";
    paramArrayOfResultSet2[0] = localStatement2.executeQuery(str3);
  }

  public static void RS332(ResultSet[] paramArrayOfResultSet1, ResultSet[] paramArrayOfResultSet2)
    throws Exception
  {
    String str1 = "jdbc:default:connection";
    ...
    String str2 = "select * from b2unl17";
