...
public class Jdbc_Get_Timestamp
{
  public static void getTimestamp(Timestamp[] paramArrayOfTimestamp)
    throws Exception
  {
    ...
    String str2 = "select tscol from jdbctest where integercol=1";
    ...
    localResultSet.next();
    paramArrayOfTimestamp[0] = localResultSet.getTimestamp(1);
