...
public class Jdbc_Get_Long
{
  public static void getLong(long[] paramArrayOfLong)
    throws Exception
  {
    ...
    String str2 = "select bigintcol from jdbctest where integercol=2";
    ...
    localResultSet.next();
    paramArrayOfLong[0] = localResultSet.getLong(1);
