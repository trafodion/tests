...
public class Jdbc_Get_BigDeci
{
  public static void getBigDecimal(BigDecimal[] paramArrayOfBigDecimal)
    throws Exception
  {
    ...
    localResultSet.next();
    paramArrayOfBigDecimal[0] = localResultSet.getBigDecimal(1);
  }
}
