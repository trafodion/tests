...
public class Procs
{
  ...
  public static void N0219(int paramInt, int[] paramArrayOfInt)
  {
    ...
    try
    {
      ...
      localStatement.executeUpdate("INSERT INTO atable values(12,1,6534567890,'Henry Dickenson',1239927,1.201227E13,60050.50,7.784225,date '1999-12-10',time '11:59:59',timestamp '2001-01-10 10:45:59') ");
      ResultSet localResultSet;
      try {
        localResultSet = localStatement.executeQuery("SELECT COUNT(*) from atable");
      } catch (SQLException localSQLException3) {
        sop("Problem reading scale");
        sop(localSQLException3.getMessage());
  ...
  public static void N0220(int paramInt, int[] paramArrayOfInt)
  {
    ...
    try {
      ...
      ResultSet localResultSet;
      try {
        localResultSet = localStatement.executeQuery("SELECT id FROM atable WHERE index = 1");
      } catch (SQLException localSQLException3) {
        sop("Problem reading scale");
        sop(localSQLException3.getMessage());
        localSQLException3.printStackTrace();
  ...
  public static void N0221(int paramInt, int[] paramArrayOfInt)
  {
    ...
    {
      Statement localStatement = localConnection.createStatement();
      localStatement.executeUpdate("INSERT INTO atable values(14,9,1234561190,'Linda Baxter',1211587,1.001227E11,65210.50,7.781255,date '2001-12-11',time '11:39:59',timestamp '2001-11-10 10:45:59') ");
      ResultSet localResultSet;
      try {
        localResultSet = localStatement.executeQuery("SELECT COUNT(*) from atable");
      } catch (SQLException localSQLException3) {
    ...
    throws Exception
  {
    ...
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0219(?,?)}");
    localCallableStatement.setInt(1, 21);
    localCallableStatement.registerOutParameter(2, 4);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    try
    {
      localResultSet = localCallableStatement.executeQuery("SELECT COUNT(*) from atable");
    } catch (SQLException localSQLException2) {
        sop("Problem reading scale");
        sop(localSQLException2.getMessage());
  ...
  public static void N1209(Double paramDouble, int[] paramArrayOfInt)
  {
    ...
    try {
      ...
      ResultSet localResultSet;
      try {
        localResultSet = localStatement.executeQuery("SELECT salary from atable where index = 13");
      } catch (SQLException localSQLException3) {
        sop("Problem reading scale");
        sop(localSQLException3.getMessage());
        localSQLException3.printStackTrace();
  ...
  public static void N1210(Double paramDouble, int[] paramArrayOfInt)
  {
    ...
    try
    {
      localConnection = DriverManager.getConnection(str);
      Statement localStatement = localConnection.createStatement();
      localStatement.executeUpdate("UPDATE atable SET salary = 150000 WHERE index = 9");
  ...
  public static void N1211(Double paramDouble, int[] paramArrayOfInt)
  {
    ...
    try
    {
      ...
      try {
        ...
        sop("Problem using transactional statement");
        sop(localSQLException3.getMessage());
        localSQLException3.printStackTrace();
        return;
      }
    ...
    throws Exception
  {
    ...
    try
    {
      localFileOutputStream = new FileOutputStream("abc.out");
      localPrintWriter = new PrintWriter(localFileOutputStream);

      localPrintWriter.println("IN1 value  :" + paramBigDecimal);
      localPrintWriter.println("OUT1 value :" + i);
  ...
  public static void N4220(short paramShort, long[] paramArrayOfLong)
  {
  ...
  public static void N4264(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
  ...
  public static void N4288(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    paramArrayOfString[0] = paramString;
    byte[] arrayOfByte = "This is a string of text.".getBytes();
    FileOutputStream localFileOutputStream = new FileOutputStream("/usr/spjqa/Testware/Class/read.java");
    localFileOutputStream.write(arrayOfByte);
    localFileOutputStream.close();
    System.err.println("The file does not have read permission");
  }

  public static void N4289(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    paramArrayOfString[0] = paramString;
    byte[] arrayOfByte = "This is a string of text.".getBytes();
    FileOutputStream localFileOutputStream = new FileOutputStream("/usr/spjqa/Testware/Class/write.java");
    localFileOutputStream.write(arrayOfByte);
    localFileOutputStream.close();
    System.err.println("The file does not have read permission");
  }

  public static void C055(String paramString)
  {
    System.out.println("IN1 Value    :" + paramString);
  }

  public static void C057(Double paramDouble)
  {
    System.out.println("IN1 Value    :" + paramDouble);
  }

  public static void C058(BigDecimal paramBigDecimal)
  {
    System.out.println("IN1 Value    :" + paramBigDecimal);
  }

  public static void C060(Date paramDate)
  {
    System.out.println("IN1 Value    :" + paramDate);
  }

  public static void C061(Time paramTime)
  {
    System.out.println("IN1 Value    :" + paramTime);
  }

  public static void C062(Timestamp paramTimestamp)
  {
    System.out.println("IN1 Value    :" + paramTimestamp);
  }

  public static void C065(Float paramFloat)
  {
    System.out.println("IN1 Value    :" + paramFloat);
  }

  public static void N0175(BigDecimal paramBigDecimal)
  {
    System.out.println("IN1 Value    :" + paramBigDecimal);
  }
  ...
  public static void N0188A(Integer paramInteger)
  {
    System.out.println("IN1 Value    :" + paramInteger);
  }
  ...
  {
    paramArrayOfString[0] = paramString.trim();
  }

  public static void N0200T(String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
    paramArrayOfString2[0] = paramArrayOfString1[0];
  }
  ...
  public static void N0202a(BigDecimal paramBigDecimal, BigDecimal[] paramArrayOfBigDecimal)
  {
    paramArrayOfBigDecimal[0] = paramBigDecimal;
  }
  ...
  public static void N0210A(int paramInt, BigInteger[] paramArrayOfBigInteger)
  {
  }
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer(paramString.trim());
  ...
  public static void N0227(String paramString, String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      ResultSet localResultSet;
      try {
        localResultSet = localStatement.executeQuery("select user from testtab");
      } catch (SQLException localSQLException3) {
        sop("Problem reading table");
        sop(localSQLException3.getMessage());
        localSQLException3.printStackTrace();
        return;
      }
  ...
  public static void N0228(String paramString, String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      ResultSet localResultSet;
      try {
        localResultSet = localStatement.executeQuery("select current_user from testtab");
      } catch (SQLException localSQLException3) {
        sop("Problem reading table");
        sop(localSQLException3.getMessage());
        localSQLException3.printStackTrace();
  ...
  public static void N0229(String paramString, String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      ResultSet localResultSet;
      try {
        localResultSet = localStatement.executeQuery("select ename from testtab");
      } catch (SQLException localSQLException3) {
        sop("Problem reading table");
        sop(localSQLException3.getMessage());
        localSQLException3.printStackTrace();
    ...
    throws Exception
  {
    ...
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0244(?,?)}");
...
try { Statement localStatement = localConnection.createStatement();
      ...
      try { localResultSet1 = localStatement.executeQuery("select e_name from testtab");
        localResultSet2 = localStatement.executeQuery("select e_num from testtab");
        localResultSet3 = localStatement.executeQuery("select e_city from testtab");
        localResultSet4 = localStatement.executeQuery("select e_title from testtab");
        localResultSet5 = localStatement.executeQuery("select e_salary from testtab");
        localResultSet6 = localStatement.executeQuery("select e_code from testtab");
        localResultSet7 = localStatement.executeQuery("select e_date from testtab");
        localResultSet8 = localStatement.executeQuery("select e_time from testtab");
        localResultSet9 = localStatement.executeQuery("select e_tstamp from testtab");
        localResultSet10 = localStatement.executeQuery("select e_long from testtab");
        localResultSet11 = localStatement.executeQuery("select e_float from testtab");
        localResultSet12 = localStatement.executeQuery("select e_real from testtab");
        localResultSet13 = localStatement.executeQuery("select e_double from testtab");
        localResultSet14 = localStatement.executeQuery("select e_numeric from testtab");
        localResultSet15 = localStatement.executeQuery("select e_decimal from testtab");
        localResultSet16 = localStatement.executeQuery("select e_numeric1 from testtab");
        localResultSet17 = localStatement.executeQuery("select e_decimal1 from testtab");
      } catch (SQLException localSQLException3)
      {
        sop("Problem reading table");
        sop(localSQLException3.getMessage());
  ...
  public static void N0236(String paramString, long[] paramArrayOfLong)
  {
    paramArrayOfLong[0] = Long.valueOf(paramString).longValue();
  }

  public static void N0237(String paramString, double[] paramArrayOfDouble)
  {
    paramArrayOfDouble[0] = Double.valueOf(paramString).doubleValue();
  }
    ...
    throws Exception
  {
    ...
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0235(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ...
    try
    {
      localResultSet1 = localCallableStatement.executeQuery("select e_name from testtab");
    } catch (SQLException localSQLException2) {
        sop("Problem reading table");
        sop(localSQLException2.getMessage());
        localSQLException2.printStackTrace();
    ...
    throws Exception
  {
    ...
    System.err.println("Executing procedure N0245");
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0245(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    ...
    throws Exception
  {
    ...
    Statement localStatement = localConnection.createStatement();
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0246");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0246(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
    ...
    throws Exception
  {
    ...
    Statement localStatement = localConnection.createStatement();
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0247");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0247(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
    ...
    throws Exception
  {
    ...
    Statement localStatement = localConnection.createStatement();
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0248");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0248(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
    ...
    throws Exception
  {
    ...
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0249");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0249(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
    ...
    throws Exception
  {
    ...
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0250");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0250(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
    ...
    throws Exception
  {
    ...
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0251");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0251(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
    ...
    throws Exception
  {
    ...
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0252");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0252(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
  ...
  public static void N0252(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
    ...
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0253");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0253(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
  ...
  public static void N0253(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
    ...
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0254");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0254(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
  ...
  public static void N0254(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
    ...
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890, 'San Francisco', 'programmer', 123456789, 32766, date '2001-10-31',  time '10:10:10',  timestamp '2001-10-10 10:10:10.00', 123456789987654321, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    System.err.println("Executing procedure N0255");
    CallableStatement localCallableStatement = localConnection.prepareCall("{call N0255(?,?)}");
    localCallableStatement.setString(1, "Smith");
    localCallableStatement.registerOutParameter(2, 1);
    ResultSet localResultSet = localCallableStatement.executeQuery();
    localStatement.close();
  ...
  public static void N0255(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
  ...
  public static void N0256(String paramString, String[] paramArrayOfString)
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
  ...
  public static void N0275(String paramString, String[] paramArrayOfString)
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
    try
  ...
  {
    paramArrayOfString2[0] = paramArrayOfString1[0].trim();
    paramArrayOfString1[0] = paramString.trim();
  }
  ...
  public static void N0307(int paramInt, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    paramArrayOfInt1[0] = paramArrayOfInt2[0];
    paramArrayOfInt2[0] = paramInt;
  }
  ...
  public static void N0311(BigDecimal paramBigDecimal, BigDecimal[] paramArrayOfBigDecimal1, BigDecimal[] paramArrayOfBigDecimal2)
  {
    ...
    System.err.println("IN1 value                 :   " + paramBigDecimal);
  }
  ...
  public static void N1107(String paramString, String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
    paramArrayOfString2[0] = paramArrayOfString1[0];
    paramArrayOfString1[0] = paramString;
  }
  ...
  public static void N1699(double[] paramArrayOfDouble)
    throws Exception
  {
    Connection localConnection = null;
    ...
    String str2 = "select e_double from testtab";
  ...
  {
    paramArrayOfInteger[0] = new Integer(paramString.trim());
  }
  ...
  {
    if ((paramDate == null) && (paramArrayOfDate[0] == null)) {
      paramArrayOfString1[0] = "NULL";
      paramArrayOfString2[0] = "NULL";
    ...
    throws Exception
  {
    ...
    localConnection = DriverManager.getConnection(str);
    Statement localStatement = localConnection.createStatement();
    localStatement.executeUpdate("insert into emp values('Hewlett Packard')");
    localStatement.executeUpdate("rollback work");
  }

  public static void N0120C()
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
    ...
    localConnection = DriverManager.getConnection(str);
    Statement localStatement = localConnection.createStatement();
    localStatement.executeUpdate("insert into emp values('Hewlett Packarrd')");
    localStatement.executeUpdate("commit work");
  }

  public static void N0120D()
    throws Exception
  {
    Connection localConnection = null;
    String str = "jdbc:default:connection";
    ...
    localConnection = DriverManager.getConnection(str);
    Statement localStatement = localConnection.createStatement();
    localStatement.executeUpdate("begin work");
    localStatement.executeUpdate("insert into emp values('Hewlett Packarrd')");
    localStatement.executeUpdate("commit work");
  }

  public static void N0291(String paramString, String[] paramArrayOfString)
  {
    paramArrayOfString[0] = paramString.trim();
  }

  public static void N0292(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    paramArrayOfString[0] = (paramString1.trim() + paramString2.trim());
  }

  public static void N0200A(String paramString, String[] paramArrayOfString)
  {
    paramArrayOfString[0] = paramString;
  }

  public static void N0260(byte paramByte, byte[] paramArrayOfByte)
  {
    ...
    throws Exception
  {
    ...
    localConnection = DriverManager.getConnection(str);
    Statement localStatement = localConnection.createStatement();
    localStatement.executeUpdate("insert into testtab values('AAA Computers', 1234567890,'San Francisco', 'programmer',123456789,32766, date '2001-10-31',  time '10:10:10', timestamp '2001-10-10 10:10:10.00', 123456789, 3.40E+37, 3.0125E+18, 1.78145E+75, 8765432.45678,  8765478.56895,  987654321.0,  123456789.0)");
    localStatement.close();
  }
}
