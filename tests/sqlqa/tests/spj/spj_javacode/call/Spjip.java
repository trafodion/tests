...
public class Spjip
{
  ...
  public static void N1215(float paramFloat, double[] paramArrayOfDouble, float[] paramArrayOfFloat)
  {
    paramArrayOfFloat[0] = ((float)paramArrayOfDouble[0]);
    paramArrayOfDouble[0] = paramFloat;
  }

  public static void N1217(double paramDouble, BigDecimal[] paramArrayOfBigDecimal, double[] paramArrayOfDouble)
  {
    paramArrayOfBigDecimal[0] = new BigDecimal(paramArrayOfDouble[0]);
    paramArrayOfDouble[0] = paramDouble;
  }

  public static void N1221(double paramDouble, short[] paramArrayOfShort, double[] paramArrayOfDouble)
  {
    paramArrayOfShort[0] = ((short)(int)paramArrayOfDouble[0]);
    paramArrayOfDouble[0] = paramDouble;
  }

  public static void N1222(double paramDouble, short[] paramArrayOfShort, double[] paramArrayOfDouble)
  {
    paramArrayOfShort[0] = ((short)(int)paramArrayOfDouble[0]);
    paramArrayOfDouble[0] = paramDouble;
  }

  public static void N1223(double paramDouble, long[] paramArrayOfLong, double[] paramArrayOfDouble)
  {
    paramArrayOfLong[0] = ((long)paramArrayOfDouble[0]);
    paramArrayOfDouble[0] = paramDouble;
  }

  public static void N1224(double paramDouble, int[] paramArrayOfInt, double[] paramArrayOfDouble)
  {
    paramArrayOfInt[0] = ((int)paramArrayOfDouble[0]);
    paramArrayOfDouble[0] = paramDouble;
  }

  public static void N1225(double paramDouble, double[] paramArrayOfDouble1, double[] paramArrayOfDouble2)
  {
    paramArrayOfDouble1[0] = paramArrayOfDouble2[0];
    paramArrayOfDouble2[0] = paramDouble;
  }
  ...
  public static void N1279(double[] paramArrayOfDouble1, double[] paramArrayOfDouble2)
  {
    paramArrayOfDouble2[0] = paramArrayOfDouble1[0];
  }
  ...
  public static void N1301(float[] paramArrayOfFloat, double[] paramArrayOfDouble)
  {
    paramArrayOfDouble[0] = paramArrayOfFloat[0];
  }
  ...
  {
    paramArrayOfBigDecimal[0] = new BigDecimal(paramArrayOfString[0].trim());
  }
  ...
  public static void N1312(String[] paramArrayOfString, double[] paramArrayOfDouble)
  {
    paramArrayOfDouble[0] = Float.valueOf(paramArrayOfString[0]).floatValue();
  }
