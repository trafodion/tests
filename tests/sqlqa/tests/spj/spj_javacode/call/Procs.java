...
try { Statement localStatement = localConnection.createStatement();
      ...
      ResultSet localResultSet;
      try { localResultSet = localStatement.executeQuery("select user from testtab");
      } catch (SQLException localSQLException2) {
...
try { Statement localStatement = localConnection.createStatement();
      ...
      System.out.println("SQL insert completed");
      ResultSet localResultSet;
      try { localResultSet = localStatement.executeQuery("select current_user from testtab");
      } catch (SQLException localSQLException2) {
        System.out.println("Problem reading table");
        while (localSQLException2 != null) {
          System.out.println("Message:" + localSQLException2.getMessage());
...
try { Statement localStatement = localConnection.createStatement();
      ...
      System.out.println("SQL insert completed");
      ResultSet localResultSet;
      try { localResultSet = localStatement.executeQuery("select ename from testtab");
      } catch (SQLException localSQLException2) {
        System.out.println("Problem reading table");
        while (localSQLException2 != null) {
          System.out.println("Message:" + localSQLException2.getMessage());
...
CallableStatement localCallableStatement = localConnection.prepareCall("{call N0235(?,?)}");
    ...
    ResultSet localResultSet1;
    try { localResultSet1 = localCallableStatement.executeQuery("select e_name from testtab");
    } catch (SQLException localSQLException1) {
      System.out.println("Problem reading table");
      while (localSQLException1 != null) {
        System.out.println("Message:" + localSQLException1.getMessage());
