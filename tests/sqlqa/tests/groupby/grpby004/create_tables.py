...
INTERVAL '9-03'  YEAR TO MONTH, TIME '08:30:30',
TIMESTAMP '2007-06-01:16:30:30');"""
    output = _dci.cmdexec(stmt)
    _dci.expect_inserted_msg(output, 1)
    
    stmt = """INSERT INTO emp
values ( 'CRINAR', 'JESSICA', 3500, 39500.00, 2, DATE '1999-05-06',
INTERVAL '8-01'  YEAR TO MONTH, TIME '08:45:00',
TIMESTAMP '2007-06-01:16:45:00');"""
    output = _dci.cmdexec(stmt)
    _dci.expect_inserted_msg(output, 1)
    
    stmt = """INSERT INTO emp
values ('GREEN','ROGER',  9000, 175500.00, 2, DATE '2000-01-02',
INTERVAL '7-05'  YEAR TO MONTH, TIME '09:00:00',
TIMESTAMP '2007-06-01:17:00:00');"""
    output = _dci.cmdexec(stmt)
    _dci.expect_inserted_msg(output, 1)
    
    stmt = """INSERT INTO emp
values ('HOWARD', 'JERRY', 1000, 65000.00, 1, DATE '2002-12-11',
INTERVAL '4-06'  YEAR TO MONTH, TIME '09:15:30',
TIMESTAMP '2007-06-01:17:15:30');"""
    output = _dci.cmdexec(stmt)
    _dci.expect_inserted_msg(output, 1)
