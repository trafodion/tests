...
def _init(hptestmgr, testlist=[]):
    ...
    stmt = """create table btuwl08
(
varchar0_100     VarChar(1000)   not null,    -- len = 16,1000
...
varchar16_100    VarChar(128)       not null,    -- len = 16,64
...
varchar20_1000   VarChar(100)   not null,    -- len = 16,64
