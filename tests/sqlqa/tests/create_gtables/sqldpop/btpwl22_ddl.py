...
# single signed decimal column key
...
def _init(hptestmgr, testlist=[]):
    ...
    stmt = """Create Table btpwl22
(
udec0_2000       PIC 9(9)          not null,
ubin0_1000       PIC 9(9) COMP     not null,
sdec0_uniq       PIC S9(9)  not null, -- range: 0-149999
char0_1000       PIC X(8)          not null,
...
primary key ( sdec0_uniq ASC) not droppable
)
