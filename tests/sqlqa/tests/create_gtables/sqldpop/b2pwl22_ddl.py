...
# multi-column contiguous (but not in order) primary key
# non-unique TIMESTAMP lead-off column
# 5000 recs
...
primary key  (  ts1_100, double1_uniq, int1_d_100 DESC) not droppable
) no partition
