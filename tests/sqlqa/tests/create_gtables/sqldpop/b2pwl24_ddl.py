...
# non-unique REAL lead-off column
# 5000 recs
...
char17_2            Character(8)               not null,    
    -- NCI     primary key  (  real0_20, varchar0_500, double1_uniq) not droppable

primary key (date2_uniq asc, varchar0_500 asc, sbin17_uniq asc) not droppable
)
