...
udec0_uniq       PIC 9(9)          not null,
char0_uniq       PIC X(128)        not null,    
...
sdec8_uniq       PIC S9(3)V9             not null,
...
udec10_uniq      PIC 9(9)         not null,
sdec10_500       PIC S9(18)       not null,    

sbin11_uniq      PIC S9(5) COMP          not null,
...
ubin17_uniq      PIC 9(7)V9(2) COMP    not null,
...
sbin20_uniq      PIC S9(16)V9(2) COMP   not null,
udec20_uniq      PIC 9(9)               not null,
ubin20_1000      PIC 9(3)V9 COMP        not null,
char20_10        PIC X(300)   not null, -- len = 64,300
sdec20_uniq      PIC S9(9)   not null, -- range: 0-14999    

primary key ( char16_uniq   DESC,
ubin0_1000    ASC,
sbin2_2       ASC,
sdec12_100    DESC,
udec16_1000   ASC  ) not droppable
)
