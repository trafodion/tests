...
# multi-column contiguous key
# unique lead-off column
# 5000 recs, 105 columns
def _init(hptestmgr, testlist=[]):
    ...
    stmt = """Create Table btpwl20
(
char0_10         PIC X(8)          not null,
udec0_2000       PIC 9(9)          not null,
ubin0_uniq       PIC 9(9) COMP     not null,
sbin0_100        PIC S9(9) COMP    not null,
sdec0_20         PIC S9(9)         not null,    
...
sdec7_10         Decimal(4) signed       not null,
char7_uniq       Character(16)           not null,
udec7_20         Decimal(4) unsigned     not null,
ubin7_100        SMALLINT unsigned       not null,    

sbin8_1000       Numeric(18) signed      not null,
char8_500        PIC X(16)               not null,
sdec8_2000       PIC S9(4)               not null,
udec8_500        PIC 9(4)                not null,
ubin8_2          Numeric(4) unsigned     not null,    

sbin9_4          PIC S9(4) COMP        not null,
char9_uniq       Character(8)          not null,
udec9_10         Decimal(5) unsigned   not null,
sdec9_20         Decimal(5) signed     not null,
ubin9_100        PIC 9(4) COMP         not null,    
...
sdec11_20        Decimal(5) signed       not null,
udec11_20        Decimal(5) unsigned     not null,
...
udec15_4         Decimal(9) unsigned     not null,
char15_uniq      Character(8)            not null,
ubin15_uniq      INTEGER unsigned        not null,
sdec15_10        Decimal(9) signed       not null,    

sbin16_20        Numeric(9) signed     not null,
sdec16_100       PIC S9(9)             not null,
ubin16_1000      Numeric(9) unsigned   not null,
udec16_1000      PIC 9(9)              not null,
char16_uniq      PIC X(8)              not null,    

sbin17_uniq      Numeric(10) signed    not null,
sdec17_20        Decimal(2) signed     not null,
ubin17_2000      PIC 9(9) COMP         not null,
char17_100       Character(16)         not null,
udec17_100       Decimal(2) unsigned   not null,    

sbin18_uniq      Numeric(18) signed   not null,
char18_20        PIC X(16)            not null,
...
udec19_100       Decimal(4) signed       not null,
sdec19_1000      Decimal(4) unsigned     not null,    

sbin20_2000      PIC S9(18) COMP        not null,
udec20_uniq      PIC 9(9)               not null,
ubin20_1000      PIC 9(4) COMP          not null,
char20_10        PIC X(8)               not null,
sdec20_uniq      PIC S9(9)   not null, -- range: 0-149999    

primary key ( ubin0_uniq ASC,
sbin0_100 DESC,
sdec0_20 ASC) not droppable
)
