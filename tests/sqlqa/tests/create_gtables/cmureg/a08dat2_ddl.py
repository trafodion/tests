...
, int1 int unsigned constraint int_uniq_cmureg_a08dat2 check (int1 < 10000)
...
, int14 int signed default -100 constraint int14_c_cmureg_a08dat2 check (int14 < 1234567890)
