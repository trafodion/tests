...
def create_and_load(hptestmgr, prop_file, name, file, delim, count):
    global _testmgr
    global _dci
    ...
    output = _dci.cmdexec(stmt)
    _dci.expect_any_substr(output, str(count))
