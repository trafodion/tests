...
import tests.merge.mrgext.tunit
import tests.merge.mxci.tunit
import tests.merge.updcond.tunit

class TestMerge(unittest.TestCase):
    """Regression Test: merge"""
    ...
    def test_mrgext(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.merge.mrgext.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_mxci(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.merge.mxci.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_updcond(self):
        # == NO GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.merge.updcond.tunit, testlist)
