...
def test010(desc="""PH Query 10"""):
    ...
    #control query default scratch_max_opens_sort '1';
...
def test011(desc="""PH Query 11"""):
    ...
    #set showshape on;
    # TPCH/TPC-R Important Stock Identification Query (Q11)
    # 2X rowcount 57045
    # Database -- <catalog>.<schema>
