...
import tests.create_tblas.ctascola.tunit
import tests.create_tblas.ctastablea.tunit

class TestCreate_tblas(unittest.TestCase):
    """Regression Test: create_tblas"""
    ...
    def __init__(self, *args, **kwargs):
        super(TestCreate_tblas, self).__init__(*args, **kwargs)
        pass
    ...
    def test_ctascola(self):
        # == no GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.create_tblas.ctascola.tunit, testlist)

    # @unittest.skip('skip this test')
    def test_ctastablea(self):
        # == no GLOBAL TABLES
        testlist=[]
        self.run_testunit(tests.create_tblas.ctastablea.tunit, testlist)

if __name__ == "__main__":
    #unittest.main()
    suite = unittest.TestLoader().loadTestsFromTestCase(TestCreate_tblas)
