...
def test001(desc='Order by Clustering Key'):
    global _testmgr
    global _testlist
    global _dci
...
fact.d = dim3.a;"""
    ...
    # NCI #expectfile $test_dir/A01exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
    
    # NCI #expectstat $test_dir/A01exp P4
    # NCI display statistics;
    
    _testmgr.testcase_end(desc)

def test002(desc='Join with 4 dimensions'):
    global _testmgr
    global _testlist
    global _dci
    if not _testmgr.testcase_begin(_testlist): return
...
dim3.b = 4;"""
    ...
    # NCI set envvar NO_SCREEN_OUTPUT;
    # NCI #expectfile $test_dir/A02exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
    
    # NCI #expectstat $test_dir/A02exp P4
    # NCI display statistics;
...
def test003(desc='Star Join with 3 dimensions'):
    ...
    stmt = """select fact.a, fact.b, fact.c, fact.d, fact.txt
from
 """ + gvars.g_schema_hcubedb + """.CUBE3 fact,
 """ + gvars.g_schema_hcubedb + """.T0 dim0,
 """ + gvars.g_schema_hcubedb + """.T1 dim1,
...
dim2.b = 3;"""
    ...
    # NCI set envvar NO_SCREEN_OUTPUT;
    # NCI #expectfile $test_dir/A03exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
    
    # NCI #expectstat $test_dir/A03exp P4
    # NCI display statistics;
...
dim4.b < 2;"""
    ...
    # NCI set envvar NO_SCREEN_OUTPUT;
    # NCI #expectfile $test_dir/A04exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
    
    # NCI #expectstat $test_dir/A04exp P4
    # NCI display statistics;
...
fact.f < 2;"""
    ...
    # NCI set envvar NO_SCREEN_OUTPUT;
    # NCI #expectfile $test_dir/A05exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
...
fact.f < 2;"""
    ...
    # NCI set envvar NO_SCREEN_OUTPUT;
    # NCI #expectfile $test_dir/A06exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
    
    # NCI #expectstat $test_dir/A06exp P4
    # NCI display statistics;
...
dim4.b < 5;"""
    ...
    # NCI set envvar NO_SCREEN_OUTPUT;
    # NCI #expectfile $test_dir/A07exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
    
    # NCI #expectstat $test_dir/A07exp P4
    # NCI display statistics;
...
dim3.b < 3;"""
    ...
    # NCI set envvar NO_SCREEN_OUTPUT;
    # NCI #expectfile $test_dir/A08exp P3
    # NCI execute xx;
    # NCI reset envvar NO_SCREEN_OUTPUT;
    
    # NCI #expectstat $test_dir/A08exp P4
    # NCI display statistics;
