...
def _init(hptestmgr, testlist=[]):
    ...
    stmt = gvars.inscmd + """ tab_lrg_original_05 select * from """ + gvars.g_schema_cmureg + """.btpnl17a;"""
    output = _dci.cmdexec(stmt)
    ...
    stmt = gvars.inscmd + """ tab_lrg_original_06 select * from """ + gvars.g_schema_cmureg + """.btpnl17a;"""
    output = _dci.cmdexec(stmt)
    _dci.unexpect_error_msg(output)
