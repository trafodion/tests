...
def _init(hptestmgr, testlist=[]):
    ...
    stmt = """create table tab_loc_emp_original
(
sdec0_2             PIC S9(9)             not null,
varchar0_100        varchar(16)      not null,
char0_4             Character(8)          not null,
sbin0_uniq          Numeric(18) signed    not null not droppable primary key,
...
;"""
    ...
    stmt = """create table tab_loc_ten_original
(
sdec0_2             PIC S9(9)             not null,
varchar0_100        varchar(16)      not null,
char0_4             Character(8)          not null,
...
;"""
    ...
    stmt = """create table tab_loc_lrg_original
(
sdec0_2             PIC S9(9)             not null,
varchar0_100        varchar(16)      not null,
char0_4             Character(8)          not null,
